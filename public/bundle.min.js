...
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{"default":t}}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function _inherits(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}function isset(t){return"undefined"!=typeof t}var _createClass=function(){function t(t,e){for(var i=0;i<e.length;i++){var a=e[i];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(t,a.key,a)}}return function(e,i,a){return i&&t(e.prototype,i),a&&t(e,a),e}}();Object.defineProperty(exports,"__esModule",{value:!0});var _react=require("react"),_react2=_interopRequireDefault(_react),_reactAddonsCssTransitionGroup=require("react-addons-css-transition-group"),_reactAddonsCssTransitionGroup2=_interopRequireDefault(_reactAddonsCssTransitionGroup),_axios=require("axios"),_axios2=_interopRequireDefault(_axios),_reactSocial=require("./react-social.js"),_reactSocial2=_interopRequireDefault(_reactSocial),_reactControls=require("./react-controls.js"),_reactControls2=_interopRequireDefault(_reactControls),_reactGmaps=require("./react-gmaps.js"),_reactGmaps2=_interopRequireDefault(_reactGmaps),_reactItemlist=require("./react-itemlist.js"),_reactItemlist2=_interopRequireDefault(_reactItemlist),_reactItemdetail=require("./react-itemdetail.js"),_reactItemdetail2=_interopRequireDefault(_reactItemdetail),_reactPagination=require("./react-pagination.js"),_reactPagination2=_interopRequireDefault(_reactPagination),HoH=function(t){function e(t){_classCallCheck(this,e);var i=_possibleConstructorReturn(this,Object.getPrototypeOf(e).call(this,t));return i.state={startDate:0,endDate:0,nRows:25,nPages:0,pointer:isset(t.initparams.pointer)?parseInt(t.initparams.pointer):0,tag:!1,selectedItems:[],highlightLatLong:!1,itemDetail:!1,wikiData:!1,wikiImages:!1},i.componentDidMount=i.componentDidMount.bind(i),i.handlePaginatorClicked=i.handlePaginatorClicked.bind(i),i.updateItems=i.updateItems.bind(i),i.historyUpdate=i.historyUpdate.bind(i),i.setItemDetail=i.setItemDetail.bind(i),i.hideItemDetail=i.hideItemDetail.bind(i),i.setWikiData=i.setWikiData.bind(i),i.updateDate=i.updateDate.bind(i),i.updatePointer=i.updatePointer.bind(i),i.handleMarkerClick=i.handleMarkerClick.bind(i),i.updateTag=i.updateTag.bind(i),i.renderItemDetail=i.renderItemDetail.bind(i),i}return _inherits(e,t),_createClass(e,[{key:"componentWillMount",value:function(t){this.updateItems(!1,!1,!1)}},{key:"componentDidMount",value:function(){var t=this;isset(this.props.initparams)&&this.props.initparams.year!==!1&&this.setItemDetail({target:{dataset:{year:this.props.initparams.year,position:this.props.initparams.position}}}),"undefined"!=typeof window&&History.Adapter.bind(window,"statechange",function(){t.historyUpdate()})}},{key:"handlePaginatorClicked",value:function(t){var e=parseInt(t),i=e+1;this.setState({pointer:e}),e>0?History.pushState(null,"Page "+i+" | History of Modern Humanity | Builtvisible","/history-of-humanity/p/"+i):History.pushState(null,"History of Modern Humanity | Builtvisible","/history-of-humanity/")}},{key:"updateItems",value:function(t,e,i){var a={},s=[],r=0;if(t===!1){var n=1750,o=2015;a.startDate=n,a.endDate=o}else var n="startDate"===t?parseInt(e):parseInt(this.state.startDate),o="endDate"===t?parseInt(e):parseInt(this.state.endDate);for(var l=n;o>=l;l++)for(var p=isset(this.props.timeline[l])?this.props.timeline[l].length:0,u=0;p>u;u++)(i!==!1&&this.props.timeline[l][u].tags.indexOf(i)>-1||i===!1)&&(s[r]=this.props.timeline[l][u],s[r].year=l,s[r].position=u,r++);this.state.pointer>=Math.floor(s.length/this.state.nRows)&&(a.pointer=Math.floor(s.length/this.state.nRows)),a.tag=i,a.selectedItems=s,a.nPages=Math.ceil(s.length/this.state.nRows),t!==!1&&(a[t]=e),this.setState(a)}},{key:"historyUpdate",value:function(){var t=window.location.pathname.replace("/history-of-humanity/","").split("/");null!==String(window.location.pathname).match(/\/history-of-humanity\/\d+\/\d+\/.+/i)?this.setItemDetail({target:{dataset:{year:t[0],position:t[1]}}},!1):this.hideItemDetail({target:{id:"hohContainer"}},!1)}},{key:"setItemDetail",value:function(t,e){if("function"==typeof t.preventDefault&&t.preventDefault(),isset(t.target.dataset.year))var i=t.target.dataset.year;else if(isset(t.target.parentNode.dataset.year))var i=t.target.parentNode.dataset.year;else if(isset(t.target.parentNode.parentNode.dataset.year))var i=t.target.parentNode.parentNode.dataset.year;if(isset(t.target.dataset.position))var a=t.target.dataset.position;else if(isset(t.target.parentNode.dataset.position))var a=t.target.parentNode.dataset.position;else if(isset(t.target.parentNode.parentNode.dataset.position))var a=t.target.parentNode.parentNode.dataset.position;var s=this.props.timeline[i][a];if(isset(s.links.main)){var r=s.links.main.link.replace("//en.wikipedia.org/wiki/","");this.setWikiData(r)}else this.setState({wikiData:!1,wikiImages:!1});this.setState({itemDetail:s}),isset(e)&&e===!1||History.pushState(null,s.text+" | History of Modern Humanity | Builtvisible","/history-of-humanity/"+i+"/"+a+"/"+r)}},{key:"hideItemDetail",value:function(t,e){if("hohContainer"===t.target.id||"hideItemDetail"===t.target.id||"hideItemDetail"===t.target.parentNode.id){this.setState({itemDetail:!1});var i=parseInt(this.state.pointer)+1;isset(e)&&e===!1||(0===this.state.pointer?History.pushState(null,"History of Modern Humanity | Builtvisible","/history-of-humanity/"):History.pushState(null,"Page "+i+" | History of Modern Humanity | Builtvisible","/history-of-humanity/p/"+i))}}},{key:"setWikiData",value:function(t){var e=this,i="https://en.wikipedia.org/w/api.php?format=json&action=query&prop=extracts|images&exintro=&explaintext=&titles="+t,a=_axios2["default"].get("https://apis.builtvisible.com/history_of_humanity/?url="+encodeURIComponent(i.replace(/&amp;/g,"&")));a.then(function(t){var i={wikiData:!1,wikiImages:!1};if(isset(t.data.query.pages)){var a=Object.keys(t.data.query.pages);if(i.wikiData=t.data.query.pages[a],i.wikiImages=[],isset(i.wikiData.images))for(var s=i.wikiData.images.length-1;s>=0;s--){var r=i.wikiData.images[s].title.replace("File:","").replace(/\s+/g,"_");if(-1===r.indexOf(".jpg")&&-1===r.indexOf(".png")&&0===s)i.wikiData.images.splice(s,1);else if(-1===r.indexOf(".jpg")&&-1===r.indexOf(".png")){i.wikiData.images.splice(s,1);continue}var n="https://en.wikipedia.org/w/api.php?action=query&titles=Image:"+r+"&prop=imageinfo&iiprop=url&format=json",o=_axios2["default"].get("https://apis.builtvisible.com/history_of_humanity/?url="+encodeURIComponent(n.replace(/&amp;/g,"&")));0===s?o.then(function(t){isset(t.data.query.pages[-1])&&isset(t.data.query.pages[-1].imageinfo)&&i.wikiImages.push(t.data.query.pages[-1].imageinfo[0].url),e.setState(i)})["catch"](function(t){console.log("error in xhr 2"),console.log(t)}):o.then(function(t){isset(t.data.query.pages[-1])&&isset(t.data.query.pages[-1].imageinfo)&&i.wikiImages.push(t.data.query.pages[-1].imageinfo[0].url)})["catch"](function(t){console.log("error in xhr 3"),console.log(t)})}else e.setState(i)}})["catch"](function(t){console.log("error in xhr 1"),console.log(t)})}},{key:"updateDate",value:function(t){if(!isNaN(t.x)){var e=Math.floor(t.x);"startDate"===t.name&&e!==this.state.startDate?this.updateItems("startDate",e,this.state.tag):"endDate"===t.name&&e!==this.state.endDate&&this.updateItems("endDate",e,this.state.tag)}}},{key:"updatePointer",value:function(t){var e=!0;if(isset(t.target.parentNode.dataset.pointer))var i=t.target.parentNode.dataset.pointer;else if(isset(t.target.dataset.pointer))var i=t.target.dataset.pointer;if("1"===i&&this.state.pointer+1<Math.floor(this.state.selectedItems.length/this.state.nRows))var a=this.state.pointer+1;else if("1"===i&&this.state.pointer+1>=Math.floor(this.state.selectedItems.length/this.state.nRows))e=!1;else if("0"===i&&this.state.pointer>0)var a=this.state.pointer-1;else var a=0;e&&(this.setState({pointer:a}),0===a?History.pushState(null,"History of Modern Humanity | Builtvisible","/history-of-humanity/"):History.pushState(null,"History of Modern Humanity | Builtvisible","/history-of-humanity/p/"+a))}},{key:"handleMarkerClick",value:function(t){this.setState({highlightLatLong:t})}},{key:"updateTag",value:function(t){t.preventDefault();var e=t.target.dataset.value;""===e&&(e=!1),this.updateItems("endDate",this.state.endDate,e)}},{key:"renderItemDetail",value:function(){var t=!0;if("undefined"!=typeof window){var e=window.location.pathname.replace("/history-of-humanity/","").split("/");t=isset(this.props.initparams)&&this.props.initparams.year===e[0]&&this.props.initparams.position===e[1]&&this.props.initparams.name===e[2]}var i=!1,a=!1,s=!1;if(this.state.itemDetail!==!1)var i=this.state.itemDetail;else if(isset(this.props.initwikidata)&&isset(this.props.initwikidata.itemDetail)&&t)var i=this.props.initwikidata.itemDetail;if(this.state.wikiData!==!1)var a=this.state.wikiData;else if(isset(this.props.initwikidata)&&isset(this.props.initwikidata.wikiData)&&t)var a=this.props.initwikidata.wikiData;if(this.state.wikiImages!==!1)var s=this.state.wikiImages;else if(isset(this.props.initwikidata)&&isset(this.props.initwikidata.wikiImages)&&t)var s=this.props.initwikidata.wikiImages;return i!==!1?_react2["default"].createElement("div",{key:"itemDetailContainer"},_react2["default"].createElement(_reactAddonsCssTransitionGroup2["default"],{id:"hideItemDetail",transitionName:"itemDetailTransition",transitionAppear:!0,transitionAppearTimeout:500,transitionEnterTimeout:500,transitionLeaveTimeout:500,onClick:this.hideItemDetail},_react2["default"].createElement("i",{className:"fa fa-times"})),_react2["default"].createElement(_reactItemdetail2["default"],{itemDetail:i,wikiData:a,wikiImages:s})):[]}},{key:"render",value:function(){var t=(this.state.startDate.toString()+this.state.endDate.toString(),this.state.startDate.toString()+this.state.endDate.toString()+this.state.tag+this.state.pointer),e=this.state.itemDetail!==!1||isset(this.props.initwikidata)?this.renderItemDetail():[];return _react2["default"].createElement("div",{id:"hohContainer",onClick:this.hideItemDetail},_react2["default"].createElement(_reactSocial2["default"],null),_react2["default"].createElement("div",{id:"mapAndControls"},_react2["default"].createElement(_reactGmaps2["default"],{initialZoom:3,centerLat:30,centerLng:30,mapsKey:t,items:this.state.selectedItems,pointer:this.state.pointer,handleMarkerClick:this.handleMarkerClick,show:this.state.nRows}),_react2["default"].createElement(_reactControls2["default"],{startDate:this.state.startDate,endDate:this.state.endDate,tag:this.state.tag,inputHandler:this.updateDate,tagHandler:this.updateTag,buttonHandler:this.updatePointer})),_react2["default"].createElement(_reactItemlist2["default"],{items:this.state.selectedItems,highlightLatLong:this.state.highlightLatLong,pointer:this.state.pointer,show:this.state.nRows,itemHandler:this.setItemDetail}),e,_react2["default"].createElement(_reactPagination2["default"],{nPages:this.state.nPages,maxBlocks:"11",clickHandler:this.handlePaginatorClicked,pointer:this.state.pointer}))}}]),e}(_react2["default"].Component);exports["default"]=HoH;
...
(function (process){
"use strict";var invariant=require("./invariant"),CSSCore={addClass:function(s,a){return/\s/.test(a)?"production"!==process.env.NODE_ENV?invariant(!1,'CSSCore.addClass takes only a single class name. "%s" contains multiple classes.',a):invariant(!1):void 0,a&&(s.classList?s.classList.add(a):CSSCore.hasClass(s,a)||(s.className=s.className+" "+a)),s},removeClass:function(s,a){return/\s/.test(a)?"production"!==process.env.NODE_ENV?invariant(!1,'CSSCore.removeClass takes only a single class name. "%s" contains multiple classes.',a):invariant(!1):void 0,a&&(s.classList?s.classList.remove(a):CSSCore.hasClass(s,a)&&(s.className=s.className.replace(new RegExp("(^|\\s)"+a+"(?:\\s|$)","g"),"$1").replace(/\s+/g," ").replace(/^\s*|\s*$/g,""))),s},conditionClass:function(s,a,e){return(e?CSSCore.addClass:CSSCore.removeClass)(s,a)},hasClass:function(s,a){return/\s/.test(a)?"production"!==process.env.NODE_ENV?invariant(!1,"CSS.hasClass takes only a single class name."):invariant(!1):void 0,s.classList?!!a&&s.classList.contains(a):(" "+s.className+" ").indexOf(" "+a+" ")>-1}};module.exports=CSSCore;
