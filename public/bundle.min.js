...
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function _inherits(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}function isset(t){return void 0!==t}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function t(t,e){for(var a=0;a<e.length;a++){var i=e[a];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}return function(e,a,i){return a&&t(e.prototype,a),i&&t(e,i),e}}(),_react=require("react"),_react2=_interopRequireDefault(_react),_reactAddonsCssTransitionGroup=require("react-addons-css-transition-group"),_reactAddonsCssTransitionGroup2=_interopRequireDefault(_reactAddonsCssTransitionGroup),_axios=require("axios"),_axios2=_interopRequireDefault(_axios),_reactControls=require("./react-controls.js"),_reactControls2=_interopRequireDefault(_reactControls),_reactGmaps=require("./react-gmaps.js"),_reactGmaps2=_interopRequireDefault(_reactGmaps),_reactItemlist=require("./react-itemlist.js"),_reactItemlist2=_interopRequireDefault(_reactItemlist),_reactItemdetail=require("./react-itemdetail.js"),_reactItemdetail2=_interopRequireDefault(_reactItemdetail),_reactPagination=require("./react-pagination.js"),_reactPagination2=_interopRequireDefault(_reactPagination),HoH=function(t){function e(t){_classCallCheck(this,e);var a=_possibleConstructorReturn(this,(e.__proto__||Object.getPrototypeOf(e)).call(this,t));return a.state={startDate:0,endDate:0,nRows:25,nPages:0,pointer:isset(t.initparams.pointer)?parseInt(t.initparams.pointer):0,tag:!1,selectedItems:[],highlightLatLong:!1,itemDetail:!1,wikiData:!1,wikiImages:!1},a.componentDidMount=a.componentDidMount.bind(a),a.handlePaginatorClicked=a.handlePaginatorClicked.bind(a),a.updateItems=a.updateItems.bind(a),a.historyUpdate=a.historyUpdate.bind(a),a.setItemDetail=a.setItemDetail.bind(a),a.hideItemDetail=a.hideItemDetail.bind(a),a.setWikiData=a.setWikiData.bind(a),a.updateDate=a.updateDate.bind(a),a.updatePointer=a.updatePointer.bind(a),a.handleMarkerClick=a.handleMarkerClick.bind(a),a.updateTag=a.updateTag.bind(a),a.renderItemDetail=a.renderItemDetail.bind(a),a}return _inherits(e,t),_createClass(e,[{key:"componentWillMount",value:function(t){this.updateItems(!1,!1,!1)}},{key:"componentDidMount",value:function(){var t=this;isset(this.props.initparams)&&!1!==this.props.initparams.year&&this.setItemDetail({target:{dataset:{year:this.props.initparams.year,position:this.props.initparams.position}}}),"undefined"!=typeof window&&History.Adapter.bind(window,"statechange",function(){t.historyUpdate()})}},{key:"handlePaginatorClicked",value:function(t){var e=parseInt(t),a=e+1;this.setState({pointer:e}),e>0?History.pushState(null,"Page "+a+" | Modern History of Humanity","/history-of-humanity/p/"+a):History.pushState(null,"Modern History of Humanity","/history-of-humanity/")}},{key:"updateItems",value:function(t,e,a){var i={},s=[],r=0;if(!1===t){var n=1750,o=2015;i.startDate=n,i.endDate=o}else var n="startDate"===t?parseInt(e):parseInt(this.state.startDate),o="endDate"===t?parseInt(e):parseInt(this.state.endDate);for(var p=n;p<=o;p++)for(var l=isset(this.props.timeline[p])?this.props.timeline[p].length:0,d=0;d<l;d++)(!1!==a&&this.props.timeline[p][d].tags.indexOf(a)>-1||!1===a)&&(s[r]=this.props.timeline[p][d],s[r].year=p,s[r].position=d,r++);this.state.pointer>=Math.floor(s.length/this.state.nRows)&&(i.pointer=Math.floor(s.length/this.state.nRows)),i.tag=a,i.selectedItems=s,i.nPages=Math.ceil(s.length/this.state.nRows),!1!==t&&(i[t]=e),this.setState(i)}},{key:"historyUpdate",value:function(){var t=window.location.pathname.replace("/history-of-humanity/","").split("/");null!==String(window.location.pathname).match(/\/history-of-humanity\/\d+\/\d+\/.+/i)?this.setItemDetail({target:{dataset:{year:t[0],position:t[1]}}},!1):this.hideItemDetail({target:{id:"hohContainer"}},!1)}},{key:"setItemDetail",value:function(t,e){if("function"==typeof t.preventDefault&&t.preventDefault(),isset(t.target.dataset.year))var a=t.target.dataset.year;else if(isset(t.target.parentNode.dataset.year))var a=t.target.parentNode.dataset.year;else if(isset(t.target.parentNode.parentNode.dataset.year))var a=t.target.parentNode.parentNode.dataset.year;if(isset(t.target.dataset.position))var i=t.target.dataset.position;else if(isset(t.target.parentNode.dataset.position))var i=t.target.parentNode.dataset.position;else if(isset(t.target.parentNode.parentNode.dataset.position))var i=t.target.parentNode.parentNode.dataset.position;var s=this.props.timeline[a][i];if(isset(s.links.main)){var r=s.links.main.link.replace("//en.wikipedia.org/wiki/","");this.setWikiData(r)}else this.setState({wikiData:!1,wikiImages:!1});this.setState({itemDetail:s}),isset(e)&&!1===e||History.pushState(null,s.text+" | Modern History of Humanity","/history-of-humanity/"+a+"/"+i+"/"+r)}},{key:"hideItemDetail",value:function(t,e){if("hohContainer"===t.target.id||"hideItemDetail"===t.target.id||"hideItemDetail"===t.target.parentNode.id){this.setState({itemDetail:!1});var a=parseInt(this.state.pointer)+1;isset(e)&&!1===e||(0===this.state.pointer?History.pushState(null,"Modern History of Humanity","/history-of-humanity/"):History.pushState(null,"Page "+a+" | Modern History of Humanity","/history-of-humanity/p/"+a))}}},{key:"setWikiData",value:function(t){var e=this,a="https://en.wikipedia.org/w/api.php?format=json&action=query&prop=extracts|images&exintro=&explaintext=&titles="+t;_axios2.default.get("https://wail.es/history/api.php?url="+encodeURIComponent(a.replace(/&amp;/g,"&"))).then(function(t){var a={wikiData:!1,wikiImages:!1};if(isset(t.data.query.pages)){var i=Object.keys(t.data.query.pages);if(a.wikiData=t.data.query.pages[i],a.wikiImages=[],isset(a.wikiData.images))for(var s=a.wikiData.images.length-1;s>=0;s--){var r=a.wikiData.images[s].title.replace("File:","").replace(/\s+/g,"_");if(-1===r.indexOf(".jpg")&&-1===r.indexOf(".png")&&0===s)a.wikiData.images.splice(s,1);else if(-1===r.indexOf(".jpg")&&-1===r.indexOf(".png")){a.wikiData.images.splice(s,1);continue}var n="https://en.wikipedia.org/w/api.php?action=query&titles=Image:"+r+"&prop=imageinfo&iiprop=url&format=json",o=_axios2.default.get("https://wail.es/history/api.php?url="+encodeURIComponent(n.replace(/&amp;/g,"&")));0===s?o.then(function(t){isset(t.data.query.pages[-1])&&isset(t.data.query.pages[-1].imageinfo)&&a.wikiImages.push(t.data.query.pages[-1].imageinfo[0].url),e.setState(a)}).catch(function(t){console.log("error in xhr 2"),console.log(t)}):o.then(function(t){isset(t.data.query.pages[-1])&&isset(t.data.query.pages[-1].imageinfo)&&a.wikiImages.push(t.data.query.pages[-1].imageinfo[0].url)}).catch(function(t){console.log("error in xhr 3"),console.log(t)})}else e.setState(a)}}).catch(function(t){console.log("error in xhr 1"),console.log(t)})}},{key:"updateDate",value:function(t){if(!isNaN(t.x)){var e=Math.floor(t.x);"startDate"===t.name&&e!==this.state.startDate?this.updateItems("startDate",e,this.state.tag):"endDate"===t.name&&e!==this.state.endDate&&this.updateItems("endDate",e,this.state.tag)}}},{key:"updatePointer",value:function(t){var e=!0;if(isset(t.target.parentNode.dataset.pointer))var a=t.target.parentNode.dataset.pointer;else if(isset(t.target.dataset.pointer))var a=t.target.dataset.pointer;if("1"===a&&this.state.pointer+1<Math.floor(this.state.selectedItems.length/this.state.nRows))var i=this.state.pointer+1;else if("1"===a&&this.state.pointer+1>=Math.floor(this.state.selectedItems.length/this.state.nRows))e=!1;else if("0"===a&&this.state.pointer>0)var i=this.state.pointer-1;else var i=0;e&&(this.setState({pointer:i}),0===i?History.pushState(null,"Modern History of Humanity","/history-of-humanity/"):History.pushState(null,"Modern History of Humanity","/history-of-humanity/p/"+i))}},{key:"handleMarkerClick",value:function(t){this.setState({highlightLatLong:t})}},{key:"updateTag",value:function(t){t.preventDefault();var e=t.target.dataset.value;""===e&&(e=!1),this.updateItems("endDate",this.state.endDate,e)}},{key:"renderItemDetail",value:function(){var t=!0;if("undefined"!=typeof window){var e=window.location.pathname.replace("/history-of-humanity/","").split("/");t=isset(this.props.initparams)&&this.props.initparams.year===e[0]&&this.props.initparams.position===e[1]&&this.props.initparams.name===e[2]}var a=!1,i=!1,s=!1;if(!1!==this.state.itemDetail)var a=this.state.itemDetail;else if(isset(this.props.initwikidata)&&isset(this.props.initwikidata.itemDetail)&&t)var a=this.props.initwikidata.itemDetail;if(!1!==this.state.wikiData)var i=this.state.wikiData;else if(isset(this.props.initwikidata)&&isset(this.props.initwikidata.wikiData)&&t)var i=this.props.initwikidata.wikiData;if(!1!==this.state.wikiImages)var s=this.state.wikiImages;else if(isset(this.props.initwikidata)&&isset(this.props.initwikidata.wikiImages)&&t)var s=this.props.initwikidata.wikiImages;return!1!==a?_react2.default.createElement("div",{key:"itemDetailContainer"},_react2.default.createElement(_reactAddonsCssTransitionGroup2.default,{id:"hideItemDetail",transitionName:"itemDetailTransition",transitionAppear:!0,transitionAppearTimeout:500,transitionEnterTimeout:500,transitionLeaveTimeout:500,onClick:this.hideItemDetail},_react2.default.createElement("i",{className:"fa fa-times"})),_react2.default.createElement(_reactItemdetail2.default,{itemDetail:a,wikiData:i,wikiImages:s})):[]}},{key:"render",value:function(){var t=(this.state.startDate.toString(),this.state.endDate.toString(),this.state.startDate.toString()+this.state.endDate.toString()+this.state.tag+this.state.pointer),e=!1!==this.state.itemDetail||isset(this.props.initwikidata)?this.renderItemDetail():[];return _react2.default.createElement("div",{id:"hohContainer",onClick:this.hideItemDetail},_react2.default.createElement("div",{id:"mapAndControls"},_react2.default.createElement(_reactGmaps2.default,{initialZoom:3,centerLat:30,centerLng:30,mapsKey:t,items:this.state.selectedItems,pointer:this.state.pointer,handleMarkerClick:this.handleMarkerClick,show:this.state.nRows}),_react2.default.createElement(_reactControls2.default,{startDate:this.state.startDate,endDate:this.state.endDate,tag:this.state.tag,inputHandler:this.updateDate,tagHandler:this.updateTag,buttonHandler:this.updatePointer})),_react2.default.createElement(_reactItemlist2.default,{items:this.state.selectedItems,highlightLatLong:this.state.highlightLatLong,pointer:this.state.pointer,show:this.state.nRows,itemHandler:this.setItemDetail}),e,_react2.default.createElement(_reactPagination2.default,{nPages:this.state.nPages,maxBlocks:"11",clickHandler:this.handlePaginatorClicked,pointer:this.state.pointer}))}}]),e}(_react2.default.Component);exports.default=HoH;

},{"./react-controls.js":3,"./react-gmaps.js":4,"./react-itemdetail.js":6,"./react-itemlist.js":7,"./react-pagination.js":8,"axios":10,"react":189,"react-addons-css-transition-group":26}],3:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var a=0;a<t.length;a++){var l=t[a];l.enumerable=l.enumerable||!1,l.configurable=!0,"value"in l&&(l.writable=!0),Object.defineProperty(e,l.key,l)}}return function(t,a,l){return a&&e(t.prototype,a),l&&e(t,l),t}}(),_react=require("react"),_react2=_interopRequireDefault(_react),_reactInputslider=require("./react-inputslider.js"),_reactInputslider2=_interopRequireDefault(_reactInputslider),Controls=function(e){function t(){_classCallCheck(this,t);var e=_possibleConstructorReturn(this,(t.__proto__||Object.getPrototypeOf(t)).call(this));return e.tags=[{value:"",title:"All"},{value:"art",title:"Art"},{value:"cold war",title:"Cold War"},{value:"conflict",title:"Conflict"},{value:"crime",title:"Crime"},{value:"death",title:"Death"},{value:"disaster",title:"Disaster"},{value:"ecology",title:"Ecology"},{value:"economy",title:"Economy"},{value:"equality",title:"Equality"},{value:"exploration",title:"Exploration"},{value:"government",title:"Government"},{value:"history",title:"History"},{value:"internal conflict",title:"Internal Conflict"},{value:"natural disaster",title:"Natural Disaster"},{value:"person",title:"Person"},{value:"religion",title:"Religion"},{value:"science",title:"Science"},{value:"social",title:"Social"},{value:"space",title:"Space"},{value:"sport",title:"Sport"},{value:"technology",title:"Technology"},{value:"terrorism",title:"Terrorism"},{value:"toys",title:"Toys"},{value:"transport",title:"Transport"},{value:"treaty",title:"Treaty"},{value:"world population",title:"World Population"},{value:"ww1",title:"WW1"},{value:"ww2",title:"WW2"}],e.toggleTags=e.toggleTags.bind(e),e.hideTags=e.hideTags.bind(e),e.tagHandler=e.tagHandler.bind(e),e.renderTag=e.renderTag.bind(e),e.state={showTags:!1},e}return _inherits(t,e),_createClass(t,[{key:"toggleTags",value:function(){this.setState({showTags:!this.state.showTags})}},{key:"hideTags",value:function(){this.setState({showTags:!1})}},{key:"tagHandler",value:function(e){this.hideTags(),this.props.tagHandler(e)}},{key:"renderTag",value:function(e){return _react2.default.createElement("li",{key:e.value,"data-value":e.value,onClick:this.tagHandler},e.title)}},{key:"render",value:function(){for(var e=[],t="All",a=this.tags.length-1;a>=0;a--)this.state.showTags&&(e[a]=this.renderTag(this.tags[a])),this.props.tag===this.tags[a].value&&(t=this.tags[a].title);var l="dropdown";return this.state.showTags&&(l+=" active"),_react2.default.createElement("div",{id:"controls"},_react2.default.createElement("div",{className:"panel"},_react2.default.createElement("label",{htmlFor:"startDate"},"Start Date"),_react2.default.createElement("div",{className:"yearPanel"},this.props.startDate),_react2.default.createElement(_reactInputslider2.default,{axis:"x",x:this.props.startDate,xMin:1750,xMax:2014,name:"startDate",onChange:this.props.inputHandler})),_react2.default.createElement("div",{className:"panel"},_react2.default.createElement("label",{htmlFor:"endDate"},"End Date"),_react2.default.createElement("div",{className:"yearPanel"},this.props.endDate),_react2.default.createElement(_reactInputslider2.default,{axis:"x",x:this.props.endDate,xMin:1751,xMax:2015,name:"endDate",onChange:this.props.inputHandler})),_react2.default.createElement("div",{className:"panel"},_react2.default.createElement("label",null,"Tag"),_react2.default.createElement("p",{id:"tagHandler",onClick:this.toggleTags},t),_react2.default.createElement("ul",{id:"tags",className:l},e)),_react2.default.createElement("span",{className:"fa_button",id:"backButton","data-pointer":0,onClick:this.props.buttonHandler},_react2.default.createElement("i",{className:"fa fa-angle-double-left"})),_react2.default.createElement("span",{className:"fa_button",id:"forwardButton","data-pointer":1,onClick:this.props.buttonHandler},_react2.default.createElement("i",{className:"fa fa-angle-double-right"})))}}]),t}(_react2.default.Component);exports.default=Controls;

},{"./react-inputslider.js":5,"react":189}],4:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}function isset(e){return void 0!==e}Object.defineProperty(exports,"__esModule",{value:!0});var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},_createClass=function(){function e(e,t){for(var i=0;i<t.length;i++){var n=t[i];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,i,n){return i&&e(t.prototype,i),n&&e(t,n),t}}(),_react=require("react"),_react2=_interopRequireDefault(_react),GMap=function(e){function t(){_classCallCheck(this,t);var e=_possibleConstructorReturn(this,(t.__proto__||Object.getPrototypeOf(t)).call(this));return e.markers=[],e.latlongs=[],e.componentDidMount=e.componentDidMount.bind(e),e.componentWillUnmount=e.componentWillUnmount.bind(e),e.shouldComponentUpdate=e.shouldComponentUpdate.bind(e),e.componentDidUpdate=e.componentDidUpdate.bind(e),e.updateDimensions=e.updateDimensions.bind(e),e.clearMarkers=e.clearMarkers.bind(e),e.createMarkers=e.createMarkers.bind(e),e.setMapOnAll=e.setMapOnAll.bind(e),e.createMap=e.createMap.bind(e),e.checkBounds=e.checkBounds.bind(e),e}return _inherits(t,e),_createClass(t,[{key:"componentDidMount",value:function(e){var t=this;"object"===("undefined"==typeof google?"undefined":_typeof(google))&&(this.map=this.createMap(),google.maps.event.addListener(this.map,"center_changed",function(){t.checkBounds(t.map)}),google.maps.event.addDomListener(window,"resize",function(){var e=t.map.getCenter();google.maps.event.trigger(t.map,"resize"),t.map.setCenter(e)}),this.props.items.length>0&&this.createMarkers(),window.addEventListener("resize",this.updateDimensions)),this.updateDimensions()}},{key:"componentWillUnmount",value:function(){"undefined"!=typeof window&&window.removeEventListener("resize",this.updateDimensions)}},{key:"shouldComponentUpdate",value:function(e,t){return e.mapsKey!==this.props.mapsKey||null!==this.state&&isset(this.state.width)&&isset(t.width)&&t.width!==this.state.width}},{key:"componentDidUpdate",value:function(){"object"===("undefined"==typeof google?"undefined":_typeof(google))&&(this.clearMarkers(),this.createMarkers())}},{key:"updateDimensions",value:function(e){if("undefined"!=typeof window){var t=getViewportSize(),i={height:"600px",width:"1300px"};t.width<640?(i.height="250px",i.width="285px"):t.width>640&&t.width<800?(i.height="325px",i.width="425px"):t.width>800&&t.width<1024?(i.height="455px",i.width="625px"):t.width>1024&&t.width<1376?i.width="900px":t.width>1376&&t.width<1840&&(i.width="1200px"),this.setState(i)}}},{key:"clearMarkers",value:function(){this.setMapOnAll(null),this.markers=[],this.latlongs=[]}},{key:"createMarkers",value:function(){for(var e=this.props.pointer*this.props.show,t=this.props.pointer*this.props.show+this.props.show,i=(this.props.items[e].year,e);i<t;i++){var n=this.props.items[i];if(isset(n.latlong)&&n.latlong.length>0)for(var o=n.latlong.length-1;o>=0;o--){var r=new MarkerWithLabel({icon:{path:google.maps.SymbolPath.CIRCLE,scale:0},labelAnchor:new google.maps.Point(10,10),labelClass:"label",position:new google.maps.LatLng(n.latlong[o][0],n.latlong[o][1]),map:this.map});this.markers.push(r),this.latlongs.push(n.latlong[o])}}this.setMapOnAll(this.map)}},{key:"setMapOnAll",value:function(e){for(var t=this,i=0;i<this.markers.length;i++)this.markers[i].setMap(e),google.maps.event.addListener(this.markers[i],"click",function(e){t.props.handleMarkerClick({lat:this.position.lat().toFixed(1),long:this.position.lng().toFixed(1)})})}},{key:"createMap",value:function(){var e={maxZoom:10,minZoom:2,scrollwheel:!1,mapTypeId:google.maps.MapTypeId.ROADMAP,styles:this.style,streetViewControl:!1,mapTypeControl:!1,zoom:this.props.initialZoom,center:new google.maps.LatLng(this.props.centerLat,this.props.centerLng)};return new google.maps.Map(this.refs.mapCanvas,e)}},{key:"checkBounds",value:function(e){var t,i=e.getBounds().getNorthEast().lat(),n=e.getBounds().getSouthWest().lat(),o=Math.PI,r=Math.pow(Math.E,o),s=Math.pow(Math.E,0-o),a=(r-s)/2,l=Math.atan(a),p=180*l/o,u=0-p;if(!(i<p&&n>u)&&!(i>p&&n<u)&&(i>p&&(t=e.getCenter().lat()-(i-p)),n<u&&(t=e.getCenter().lat()-(n+85)),t)){var c=new google.maps.LatLng(t,e.getCenter().lng());e.setCenter(c)}}},{key:"render",value:function(){return _react2.default.createElement("div",{id:"gmap"},_react2.default.createElement("div",{ref:"mapCanvas",id:"mapCanvas"}))}}]),t}(_react2.default.Component);GMap.prototype.style=[{featureType:"landscape",elementType:"geometry.fill",stylers:[{visibility:"on"},{color:"#DDD4CB"}]},{featureType:"poi",stylers:[{visibility:"off"}]},{featureType:"road",stylers:[{visibility:"off"}]},{featureType:"transit",stylers:[{visibility:"off"}]},{featureType:"administrative",elementType:"labels",stylers:[{color:"#808080"},{visibility:"on"},{weight:.2}]},{featureType:"administrative.locality",stylers:[{visibility:"off"}]},{featureType:"administrative.neighborhood",stylers:[{visibility:"off"}]},{featureType:"administrative.land_parcel",stylers:[{visibility:"off"}]},{featureType:"administrative.country",elementType:"labels.text.fill",stylers:[{invert_lightness:!0},{visibility:"simplified"}]},{featureType:"administrative.country",elementType:"geometry.stroke",stylers:[{color:"#F7F5F2"},{visibility:"on"},{weight:1}]},{featureType:"administrative.province",stylers:[{visibility:"off"}]},{featureType:"water",elementType:"geometry.fill",stylers:[{color:"#F7F5F2"},{visibility:"on"}]},{featureType:"water",elementType:"labels.text.fill",stylers:[{visibility:"simplified"},{invert_lightness:!0}]},{elementType:"labels.text.fill",stylers:[{color:"#808080"}]}],exports.default=GMap;

},{"react":189}],5:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var n=0;n<t.length;n++){var i=t[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(t,n,i){return n&&e(t.prototype,n),i&&e(t,i),t}}(),_react=require("react"),_react2=_interopRequireDefault(_react),_reactDom=require("react-dom"),_reactDom2=_interopRequireDefault(_reactDom),InputSlider=function(e){function t(){_classCallCheck(this,t);var e=_possibleConstructorReturn(this,(t.__proto__||Object.getPrototypeOf(t)).call(this));return e.getPosition=e.getPosition.bind(e),e.handleSliderClick=e.handleSliderClick.bind(e),e.handleMoveStart=e.handleMoveStart.bind(e),e.handleDrag=e.handleDrag.bind(e),e.handleDragEnd=e.handleDragEnd.bind(e),e.handleClick=e.handleClick.bind(e),e.getPos=e.getPos.bind(e),e.changeValue=e.changeValue.bind(e),e.state={mobile:"undefined"!=typeof window&&mobileCheck()},e}return _inherits(t,e),_createClass(t,[{key:"getPosition",value:function(){if("x"!==this.props.axis){var e=(this.props.y-this.props.yMin)/(this.props.yMax-this.props.yMin)*100;e>100&&(e=100),e<0&&(e=0)}else var e=0;if("y"!==this.props.axis){var t=(this.props.x-this.props.xMin)/(this.props.xMax-this.props.xMin)*100;t>100&&(t=100),t<0&&(t=0)}else var t=0;return{top:e+"%",left:t+"%"}}},{key:"handleSliderClick",value:function(e){e.stopPropagation(),e.nativeEvent.stopImmediatePropagation()}},{key:"handleMoveStart",value:function(e){e.preventDefault();var t=this.refs.handle.getDOMNode();this.start={x:t.offsetLeft,y:t.offsetTop},this.offset={x:e.clientX,y:e.clientY},this.state.mobile?(document.addEventListener("touchmove",this.handleDrag),document.addEventListener("touchend",this.handleDragEnd)):(document.addEventListener("mousemove",this.handleDrag),document.addEventListener("mouseup",this.handleDragEnd))}},{key:"handleDrag",value:function(e){e.preventDefault(),this.changeValue(this.getPos(e))}},{key:"handleDragEnd",value:function(e){e.preventDefault(),this.state.mobile?(document.removeEventListener("touchmove",this.handleDrag),document.removeEventListener("touchend",this.handleDragEnd)):(document.removeEventListener("mousemove",this.handleDrag),document.removeEventListener("mouseup",this.handleDragEnd)),this.props.onDragEnd&&this.changeValue(this.getPos(e),!0)}},{key:"handleClick",value:function(e){var t=this.refs[this.props.name].getBoundingClientRect();this.changeValue({left:e.clientX-t.left,top:e.clientY-t.top},!0)}},{key:"getPos",value:function(e){if(this.state.mobile)var t=e.changedTouches[0].screenX-e.changedTouches[0].radiusX,n=e.changedTouches[0].screenY-e.changedTouches[0].radiusY;else var t=e.clientX+this.start.x-this.offset.x,n=e.clientY+this.start.y-this.offset.y;return{left:t,top:n}}},{key:"changeValue",value:function(e,t){if(this.props.onChange){var n=this.refs[this.props.name].getBoundingClientRect(),i=n.width,r=n.height,a=e.left,o=e.top,s=this.props.axis;a<0&&(a=0),a>i&&(a=i),o<0&&(o=0),o>r&&(o=r);var l=0,h=0;"x"!==s&&"xy"!==s||(l=a/i*(this.props.xMax-this.props.xMin)+this.props.xMin),"y"!==s&&"xy"!==s||(h=o/r*(this.props.yMax-this.props.yMin)+this.props.yMin),this.props.onChange({x:l,y:h,name:this.props.name}),this.props.onDragEnd&&t&&this.props.onDragEnd({x:l,y:h,name:this.props.name})}}},{key:"render",value:function(){var e=this.getPosition(),t=this.props.axis,n={};return"x"===t&&(n.width=e.left),"y"===t&&(n.height=e.top),_react2.default.createElement("div",{className:"slider slider_"+t,id:this.props.name,ref:this.props.name,onClick:this.handleClick,onTouchStart:this.handleClick},_react2.default.createElement("div",{className:"value",style:n}),_react2.default.createElement("div",{className:"handle",ref:"handle",onMouseDown:this.handleMoveStart,onTouchStart:this.handleMoveStart,onClick:this.handleSliderClick,style:e}))}}]),t}(_react2.default.Component);exports.default=InputSlider;

},{"react":189,"react-dom":27}],6:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}function isset(e){return void 0!==e}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var a=t[r];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(e,a.key,a)}}return function(t,r,a){return r&&e(t.prototype,r),a&&e(t,a),t}}(),_react=require("react"),_react2=_interopRequireDefault(_react),_reactAddonsCssTransitionGroup=require("react-addons-css-transition-group"),_reactAddonsCssTransitionGroup2=_interopRequireDefault(_reactAddonsCssTransitionGroup),ItemDetail=function(e){function t(){_classCallCheck(this,t);var e=_possibleConstructorReturn(this,(t.__proto__||Object.getPrototypeOf(t)).call(this));return e.componentWillReceiveProps=e.componentWillReceiveProps.bind(e),e.renderRelatedLink=e.renderRelatedLink.bind(e),e.noRelatedLinks=e.noRelatedLinks.bind(e),e.renderItemLocation=e.renderItemLocation.bind(e),e.noLocations=e.noLocations.bind(e),e.renderGalleryImg=e.renderGalleryImg.bind(e),e.noImages=e.noImages.bind(e),e.renderMainLink=e.renderMainLink.bind(e),e.renderControls=e.renderControls.bind(e),e.buttonHandler=e.buttonHandler.bind(e),e.renderExtract=e.renderExtract.bind(e),e.state={galleryPointer:0,maxHeight:600},e}return _inherits(t,e),_createClass(t,[{key:"componentDidMount",value:function(){"undefined"!=typeof window&&this.setState({maxHeight:getViewportSize().height-20})}},{key:"componentWillReceiveProps",value:function(){this.setState({galleryPointer:0})}},{key:"renderRelatedLink",value:function(e){return _react2.default.createElement("li",{key:"relatedLink"+e.link},_react2.default.createElement("a",{href:e.link,target:"_blank"},e.title))}},{key:"noRelatedLinks",value:function(){return _react2.default.createElement("li",{key:"relatedLink"},"No related links")}},{key:"renderItemLocation",value:function(e){return _react2.default.createElement("li",{key:"loc"+e},e)}},{key:"noLocations",value:function(){return _react2.default.createElement("li",{key:"locations"},"No locations to show")}},{key:"renderGalleryImg",value:function(e){return _react2.default.createElement("img",{key:"img"+e,className:"galleryImg",src:e})}},{key:"noImages",value:function(){return _react2.default.createElement("p",{key:"gallery"},"No images")}},{key:"renderMainLink",value:function(){return isset(this.props.itemDetail.links.main)?_react2.default.createElement("p",{key:"mainLink",id:"mainLink"},_react2.default.createElement("span",null,"Full article: "),_react2.default.createElement("a",{href:this.props.itemDetail.links.main.link,target:"_blank"},this.props.itemDetail.links.main.title)):[]}},{key:"renderControls",value:function(){return _react2.default.createElement("div",{key:"galleryControls"},_react2.default.createElement("span",{className:"fa_button",id:"galleryBack",onClick:this.buttonHandler},_react2.default.createElement("i",{className:"fa fa-angle-double-left"})),_react2.default.createElement("span",{className:"fa_button",id:"galleryForward",onClick:this.buttonHandler},_react2.default.createElement("i",{className:"fa fa-angle-double-right"})))}},{key:"buttonHandler",value:function(e){if("galleryForward"===(!isset(e.target.id)||"galleryBack"!==e.target.id&&"galleryForward"!==e.target.id?e.target.parentNode.id:e.target.id))var t=this.state.galleryPointer+3<this.props.wikiImages.length&&this.state.galleryPointer+1;else var t=!(this.state.galleryPointer-1<0)&&this.state.galleryPointer-1;t&&this.setState({galleryPointer:t})}},{key:"renderExtract",value:function(e,t){return _react2.default.createElement("p",{key:"extracts_"+t},e)}},{key:"render",value:function(){if(!1!==this.props.itemDetail){if(isset(this.props.itemDetail.links.related))var e=this.props.itemDetail.links.related.map(this.renderRelatedLink);else var e=this.noRelatedLinks();if(isset(this.props.itemDetail.locations[0]))var t=this.props.itemDetail.locations.map(this.renderItemLocation);else var t=this.noLocations();var r=this.renderMainLink();if(!1!==this.props.wikiImages&&this.props.wikiImages.length>0)for(var a=[],n=this.state.galleryPointer+3<=this.props.wikiImages.length?this.state.galleryPointer+3:this.props.wikiImages.length,i=this.state.galleryPointer;i<n;i++){var l=this.renderGalleryImg(this.props.wikiImages[i]);a.push(l)}else var a=this.noImages();if(!1!==this.props.wikiData&&!1!==this.props.wikiData.extract&&""!==this.props.wikiData.extract)var o=this.props.wikiData.extract.split("\n"),s=o.map(this.renderExtract);else s=[];var c=a.length>0?this.renderControls():[];return _react2.default.createElement(_reactAddonsCssTransitionGroup2.default,{id:"itemDetail",transitionName:"itemDetailTransition",transitionAppear:!0,transitionAppearTimeout:500,transitionEnterTimeout:500,transitionLeaveTimeout:500,style:{maxHeight:this.state.maxHeight}},_react2.default.createElement("h3",null,this.props.itemDetail.text),_react2.default.createElement("div",null,s,r),_react2.default.createElement("h4",null,"Locations"),_react2.default.createElement("ul",null,t),_react2.default.createElement("h4",null,"Related Links"),_react2.default.createElement("ul",null,e),_react2.default.createElement("div",{id:"galleryTitle"},_react2.default.createElement("h4",null,"Images"),c),_react2.default.createElement("div",{id:"gallery"},a))}}}]),t}(_react2.default.Component);exports.default=ItemDetail;

},{"react":189,"react-addons-css-transition-group":26}],7:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}function isset(e){return void 0!==e}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var i=t[r];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(t,r,i){return r&&e(t.prototype,r),i&&e(t,i),t}}(),_react=require("react"),_react2=_interopRequireDefault(_react),ItemList=function(e){function t(){_classCallCheck(this,t);var e=_possibleConstructorReturn(this,(t.__proto__||Object.getPrototypeOf(t)).call(this));return e.componentDidMount=e.componentDidMount.bind(e),e.componentWillReceiveProps=e.componentWillReceiveProps.bind(e),e.scrollAnimate=e.scrollAnimate.bind(e),e.renderYear=e.renderYear.bind(e),e.renderItemThumbnail=e.renderItemThumbnail.bind(e),e.renderItem=e.renderItem.bind(e),e.itemHandler=e.itemHandler.bind(e),e.renderItems=e.renderItems.bind(e),e.loadingItems=e.loadingItems.bind(e),e.noItems=e.noItems.bind(e),e.state={jumpTo:!1},e}return _inherits(t,e),_createClass(t,[{key:"componentDidMount",value:function(){this.jumping=!1}},{key:"componentWillReceiveProps",value:function(e){(!1===this.props.highlightLatLong&&!1!==e.highlightLatLong||this.props.highlightLatLong.lat!==e.highlightLatLong.lat)&&this.setState({jumpTo:!1})}},{key:"scrollAnimate",value:function(e,t){function r(e,t){return e<t?e:t}function i(o){var l=Date.now(),u=r(1,(l-n)/t),p=u<.5?2*u*u:(4-2*u)*u-1;a.scrollTop=p*(e-s)+s,u<1&&requestAnimationFrame(i)}var n=Date.now(),a=document.documentElement.scrollTop?document.documentElement:document.body,s=a.scrollTop;s!==e&&requestAnimationFrame(i)}},{key:"renderYear",value:function(e,t,r){return _react2.default.createElement("li",{key:"year"+e+t+r,className:"yearTitle"},r)}},{key:"renderItemThumbnail",value:function(e,t){var r="thumb"+t;return isset(e.thumbnail)&&""!==e.thumbnail?_react2.default.createElement("img",{key:r,className:"thumbnail",src:e.thumbnail}):[]}},{key:"renderItem",value:function(e,t){var t,r,i,n=0;for(t=0,i=e.text.length;t<i;t++)r=e.text.charCodeAt(t),n=(n<<5)-n+r,n|=0;var a=this.renderItemThumbnail(e,n),s="itemPanel",o=isset(this.props.highlightLatLong)&&isset(this.props.highlightLatLong.lat)&&isset(this.props.highlightLatLong.long),l=isset(e.latlong)&&isset(e.latlong[0])&&isset(e.latlong[0][0]);if(o&&l){var u=e.latlong[0][0].toFixed(1),p=e.latlong[0][1].toFixed(1);u===this.props.highlightLatLong.lat&&p===this.props.highlightLatLong.long&&(s+=" highlightMap",!1===this.state.jumpTo&&!1===this.jumping&&(this.jumping=!0,this.scrollAnimate($(n).offsetTop,1e3)))}parseInt(this.state.jumpTo)===parseInt(n)&&(s+=" highlightClick");var c=isset(e.links)&&isset(e.links.main)&&isset(e.links.main.link)?e.links.main.link.replace("//en.wikipedia.org/wiki/",""):"";return _react2.default.createElement("li",{key:n,id:n,"data-year":e.year,"data-position":e.position,className:s,onClick:this.itemHandler},a,_react2.default.createElement("p",null,_react2.default.createElement("a",{href:"/history-of-humanity/"+e.year+"/"+e.position+"/"+c},e.text)),_react2.default.createElement("div",{className:"readmore"},_react2.default.createElement("span",{"data-year":e.year,"data-position":e.position},"Read more...")))}},{key:"itemHandler",value:function(e){if(isset(e.target.id)&&""!==e.target.id)var t=e.target.id;else if(isset(e.target.parentNode.id)&&""!==e.target.parentNode.id)var t=e.target.parentNode.id;else if(isset(e.target.parentNode.parentNode.id)&&""!==e.target.parentNode.parentNode.id)var t=e.target.parentNode.parentNode.id;!1!==this.state.jumpTo&&parseInt(this.state.jumpTo)===parseInt(t)||(this.scrollAnimate($(t).offsetTop,1e3),this.setState({jumpTo:t})),this.props.itemHandler(e)}},{key:"renderItems",value:function(e){var t=[];if(this.props.items.length>0){var r=this.props.pointer*this.props.show,i=this.props.pointer*this.props.show+this.props.show,n=this.props.items[r].year;t.push(this.renderYear(r,i,this.props.items[r].year));for(var a=r;a<i;a++)isset(this.props.items[a])&&(this.props.items[a].year!==n&&(t.push(this.renderYear(a,i,this.props.items[a].year)),n=this.props.items[a].year),t.push(this.renderItem(this.props.items[a],a)))}return this.jumping=!1,t}},{key:"loadingItems",value:function(){return _react2.default.createElement("li",{className:"yearTitle"},"Loading data")}},{key:"noItems",value:function(){return _react2.default.createElement("li",{className:"yearTitle"},"No data for your selection")}},{key:"render",value:function(){if(!1===this.props.items)var e=this.loadingItems();else if(this.props.items.length>0)var e=this.renderItems();else var e=this.noItems();return _react2.default.createElement("div",{id:"items"},_react2.default.createElement("ul",null,e))}}]),t}(_react2.default.Component);exports.default=ItemList;

},{"react":189}],8:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var a=t[r];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(e,a.key,a)}}return function(t,r,a){return r&&e(t.prototype,r),a&&e(t,a),t}}(),_react=require("react"),_react2=_interopRequireDefault(_react),Pagination=function(e){function t(){_classCallCheck(this,t);var e=_possibleConstructorReturn(this,(t.__proto__||Object.getPrototypeOf(t)).call(this));return e.clickHandler=e.clickHandler.bind(e),e.updateArr=e.updateArr.bind(e),e.renderPaginationItems=e.renderPaginationItems.bind(e),e.renderNoPagination=e.renderNoPagination.bind(e),e}return _inherits(t,e),_createClass(t,[{key:"clickHandler",value:function(e){e.preventDefault(),void 0!==e.target.dataset.pointer?this.props.clickHandler(parseInt(e.target.dataset.pointer)):this.props.clickHandler(parseInt(e.target.parentNode.dataset.pointer))}},{key:"updateArr",value:function(){var e=[];if(this.props.maxBlocks-this.props.nPages<2)var t=Math.round((this.props.maxBlocks-5)/2),r=Math.max(0,this.props.pointer-t),a=Math.min(this.props.nPages-1,this.props.pointer+2*t-(this.props.pointer-r)),r=Math.max(0,r-(2*t-(a-r))),n=!0;else var r=0,a=this.props.nPages-1,n=!1;n&&0!==r&&(e[0]="prev",e[1]="hellip1");for(var i=r;i<=a;i++)e.push(i);return n&&this.props.nPages!==a+1&&(e.push("hellip2"),e.push("next")),e}},{key:"renderPaginationItems",value:function(e){var t=this.props.pointer===e?"selected clickable":"clickable";if("prev"===e)return _react2.default.createElement("li",{key:e,className:t,"data-pointer":0,onClick:this.clickHandler},_react2.default.createElement("a",{href:"/history-of-humanity/"},"1"));if("next"===e)return _react2.default.createElement("li",{key:e,className:t,"data-pointer":this.props.nPages-1,onClick:this.clickHandler},_react2.default.createElement("a",{href:"/history-of-humanity/p/"+this.props.nPages},this.props.nPages));if("hellip1"===e||"hellip2"===e)return _react2.default.createElement("li",{key:e,className:"more"},"...");var r=e+1;return _react2.default.createElement("li",{key:e,className:t,"data-pointer":e,onClick:this.clickHandler},_react2.default.createElement("a",{href:"/history-of-humanity/p/"+r},r))}},{key:"renderNoPagination",value:function(){return _react2.default.createElement("li",{className:"no_more"},"No other pages")}},{key:"render",value:function(){var e="paginator on";if(this.props.nPages>1)var t=this.updateArr(),r=t.map(this.renderPaginationItems);else if(0===this.props.nPages)var r=this.renderNoPagination();else{var r=[];e="paginator"}return _react2.default.createElement("ul",{className:e},r)}}]),t}(_react2.default.Component);exports.default=Pagination;

},{"react":189}],9:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}var _react=require("react"),_react2=_interopRequireDefault(_react),_reactDom=require("react-dom"),_reactDom2=_interopRequireDefault(_reactDom),_axios=require("axios"),_axios2=_interopRequireDefault(_axios),_timeline=require("./data/timeline.json"),_timeline2=_interopRequireDefault(_timeline),_dispatcher=require("./js/dispatcher.js"),_dispatcher2=_interopRequireDefault(_dispatcher);window.app=function(){for(var e={"JSON decoding":window.JSON,"the selectors API":document.querySelector,"DOM level 2 events":window.addEventListener,"the HTML5 history API":window.history.pushState},t=e.length-1;t>=0;t--)if(!e[t])return alert("Sorry, but your browser does not support "+feature+" so this app won't work properly.");if(null!==String(window.location.pathname).match(/\/history-of-humanity\/\d+\/\d+\/.+/i)){var i=window.location.pathname.replace("/history-of-humanity/","").split("/"),a={pointer:0,year:i[0],position:i[1],name:i[2]},r={itemDetail:_timeline2.default[a.year][a.position],wikiData:!1,wikiImages:[]},n="https://en.wikipedia.org/w/api.php?format=json&action=query&prop=extracts|images&exintro=&explaintext=&titles="+a.name;_axios2.default.get("https://wail.es/history/api.php?url="+encodeURIComponent(n.replace(/&amp;/g,"&"))).then(function(e){if(isset(e.data.query.pages)){var t=Object.keys(e.data.query.pages);return r.wikiData=e.data.query.pages[t],_reactDom2.default.render(_react2.default.createElement(_dispatcher2.default,{timeline:_timeline2.default,initparams:a,initwikidata:r}),document.getElementById("hoh"))}}).catch(function(e){console.log("error in xhr"),console.log(e)})}else{if(null===String(window.location.pathname).match(/\/history-of-humanity\/p\/\d+/i))return _reactDom2.default.render(_react2.default.createElement(_dispatcher2.default,{timeline:_timeline2.default,initparams:{pointer:0,year:!1,position:!1,name:!1}}),document.getElementById("hoh"));var i=window.location.pathname.replace("/history-of-humanity/","").split("/");if(parseInt(i[1])>0)return _reactDom2.default.render(_react2.default.createElement(_dispatcher2.default,{timeline:_timeline2.default,initparams:{pointer:parseInt(i[1])-1,year:!1,position:!1,name:!1}}),document.getElementById("hoh"));window.location.replace("https://wail.es/history-of-humanity/")}}();

},{"./data/timeline.json":1,"./js/dispatcher.js":2,"axios":10,"react":189,"react-dom":27}],10:[function(require,module,exports){
module.exports=require("./lib/axios");

},{"./lib/axios":12}],11:[function(require,module,exports){
"use strict";var defaults=require("./../defaults"),utils=require("./../utils"),buildUrl=require("./../helpers/buildUrl"),cookies=require("./../helpers/cookies"),parseHeaders=require("./../helpers/parseHeaders"),transformData=require("./../helpers/transformData"),urlIsSameOrigin=require("./../helpers/urlIsSameOrigin");module.exports=function(e,s,r){var t=transformData(r.data,r.headers,r.transformRequest),a=utils.merge(defaults.headers.common,defaults.headers[r.method]||{},r.headers||{});utils.isFormData(t)&&delete a["Content-Type"];var o=new(XMLHttpRequest||ActiveXObject)("Microsoft.XMLHTTP");o.open(r.method.toUpperCase(),buildUrl(r.url,r.params),!0),o.onreadystatechange=function(){if(o&&4===o.readyState){var t=parseHeaders(o.getAllResponseHeaders()),a=-1!==["text",""].indexOf(r.responseType||"")?o.responseText:o.response,i={data:transformData(a,t,r.transformResponse),status:o.status,statusText:o.statusText,headers:t,config:r};(o.status>=200&&o.status<300?e:s)(i),o=null}};var i=urlIsSameOrigin(r.url)?cookies.read(r.xsrfCookieName||defaults.xsrfCookieName):void 0;if(i&&(a[r.xsrfHeaderName||defaults.xsrfHeaderName]=i),utils.forEach(a,function(e,s){t||"content-type"!==s.toLowerCase()?o.setRequestHeader(s,e):delete a[s]}),r.withCredentials&&(o.withCredentials=!0),r.responseType)try{o.responseType=r.responseType}catch(e){if("json"!==o.responseType)throw e}utils.isArrayBuffer(t)&&(t=new DataView(t)),o.send(t)};
...
"use strict";var defaults=require("./defaults"),utils=require("./utils"),deprecatedMethod=require("./helpers/deprecatedMethod"),dispatchRequest=require("./core/dispatchRequest"),InterceptorManager=require("./core/InterceptorManager");!function(){var e=require("es6-promise");e&&"function"==typeof e.polyfill&&e.polyfill()}();var axios=module.exports=function e(t){t=utils.merge({method:"get",headers:{},transformRequest:defaults.transformRequest,transformResponse:defaults.transformResponse},t),t.withCredentials=t.withCredentials||defaults.withCredentials;var r=[dispatchRequest,void 0],s=Promise.resolve(t);for(e.interceptors.request.forEach(function(e){r.unshift(e.fulfilled,e.rejected)}),e.interceptors.response.forEach(function(e){r.push(e.fulfilled,e.rejected)});r.length;)s=s.then(r.shift(),r.shift());return s.success=function(e){return deprecatedMethod("success","then","https://github.com/mzabriskie/axios/blob/master/README.md#response-api"),s.then(function(t){e(t.data,t.status,t.headers,t.config)}),s},s.error=function(e){return deprecatedMethod("error","catch","https://github.com/mzabriskie/axios/blob/master/README.md#response-api"),s.then(null,function(t){e(t.data,t.status,t.headers,t.config)}),s},s};axios.defaults=defaults,axios.all=function(e){return Promise.all(e)},axios.spread=require("./helpers/spread"),axios.interceptors={request:new InterceptorManager,response:new InterceptorManager},function(){!function(){utils.forEach(arguments,function(e){axios[e]=function(t,r){return axios(utils.merge(r||{},{method:e,url:t}))}})}("delete","get","head"),function(){utils.forEach(arguments,function(e){axios[e]=function(t,r,s){return axios(utils.merge(s||{},{method:e,url:t,data:r}))}})}("post","put","patch")}();
...
(function (process){
"use strict";module.exports=function(e){return new Promise(function(r,t){try{"undefined"!=typeof window?require("../adapters/xhr")(r,t,e):"undefined"!=typeof process&&require("../adapters/http")(r,t,e)}catch(e){t(e)}})};

}).call(this,require('_process'))
},{"../adapters/http":11,"../adapters/xhr":11,"_process":25}],15:[function(require,module,exports){
"use strict";var utils=require("./utils"),PROTECTION_PREFIX=/^\)\]\}',?\n/,DEFAULT_CONTENT_TYPE={"Content-Type":"application/x-www-form-urlencoded"};module.exports={transformRequest:[function(e,t){return utils.isFormData(e)?e:utils.isArrayBuffer(e)?e:utils.isArrayBufferView(e)?e.buffer:!utils.isObject(e)||utils.isFile(e)||utils.isBlob(e)?e:(!utils.isUndefined(t)&&utils.isUndefined(t["Content-Type"])&&(t["Content-Type"]="application/json;charset=utf-8"),JSON.stringify(e))}],transformResponse:[function(e){if("string"==typeof e){e=e.replace(PROTECTION_PREFIX,"");try{e=JSON.parse(e)}catch(e){}}return e}],headers:{common:{Accept:"application/json, text/plain, */*"},patch:utils.merge(DEFAULT_CONTENT_TYPE),post:utils.merge(DEFAULT_CONTENT_TYPE),put:utils.merge(DEFAULT_CONTENT_TYPE)},xsrfCookieName:"XSRF-TOKEN",xsrfHeaderName:"X-XSRF-TOKEN"};
},{"./utils":23}],16:[function(require,module,exports){
"use strict";function encode(e){return encodeURIComponent(e).replace(/%40/gi,"@").replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%20/g,"+")}var utils=require("./../utils");module.exports=function(e,i){if(!i)return e;var t=[];return utils.forEach(i,function(e,i){null!==e&&void 0!==e&&(utils.isArray(e)||(e=[e]),utils.forEach(e,function(e){utils.isDate(e)?e=e.toISOString():utils.isObject(e)&&(e=JSON.stringify(e)),t.push(encode(i)+"="+encode(e))}))}),t.length>0&&(e+=(-1===e.indexOf("?")?"?":"&")+t.join("&")),e};
},{"./../utils":23}],17:[function(require,module,exports){
"use strict";var utils=require("./../utils");module.exports={write:function(e,t,i,n,o,u){var s=[];s.push(e+"="+encodeURIComponent(t)),utils.isNumber(i)&&s.push("expires="+new Date(i).toGMTString()),utils.isString(n)&&s.push("path="+n),utils.isString(o)&&s.push("domain="+o),!0===u&&s.push("secure"),document.cookie=s.join("; ")},read:function(e){var t=document.cookie.match(new RegExp("(^|;\\s*)("+e+")=([^;]*)"));return t?decodeURIComponent(t[3]):null},remove:function(e){this.write(e,"",Date.now()-864e5)}};
...
"use strict";module.exports=function(n){return function(t){n.apply(null,t)}};
...
(function (process){
"use strict";function insertChildAt(e,t,n){var a=n>=e.childNodes.length?null:e.childNodes.item(n);e.insertBefore(t,a)}var Danger=require("./Danger"),ReactMultiChildUpdateTypes=require("./ReactMultiChildUpdateTypes"),ReactPerf=require("./ReactPerf"),setInnerHTML=require("./setInnerHTML"),setTextContent=require("./setTextContent"),invariant=require("fbjs/lib/invariant"),DOMChildrenOperations={dangerouslyReplaceNodeWithMarkup:Danger.dangerouslyReplaceNodeWithMarkup,updateTextContent:setTextContent,processUpdates:function(e,t){for(var n,a=null,r=null,i=0;i<e.length;i++)if(n=e[i],n.type===ReactMultiChildUpdateTypes.MOVE_EXISTING||n.type===ReactMultiChildUpdateTypes.REMOVE_NODE){var s=n.fromIndex,d=n.parentNode.childNodes[s],o=n.parentID;d||("production"!==process.env.NODE_ENV?invariant(!1,"processUpdates(): Unable to find child %s of element. This probably means the DOM was unexpectedly mutated (e.g., by the browser), usually due to forgetting a <tbody> when using tables, nesting tags like <form>, <p>, or <a>, or using non-SVG elements in an <svg> parent. Try inspecting the child nodes of the element with React ID `%s`.",s,o):invariant(!1)),a=a||{},a[o]=a[o]||[],a[o][s]=d,r=r||[],r.push(d)}var l;if(l=t.length&&"string"==typeof t[0]?Danger.dangerouslyRenderMarkup(t):t,r)for(var p=0;p<r.length;p++)r[p].parentNode.removeChild(r[p]);for(var u=0;u<e.length;u++)switch(n=e[u],n.type){case ReactMultiChildUpdateTypes.INSERT_MARKUP:insertChildAt(n.parentNode,l[n.markupIndex],n.toIndex);break;case ReactMultiChildUpdateTypes.MOVE_EXISTING:insertChildAt(n.parentNode,a[n.parentID][n.fromIndex],n.toIndex);break;case ReactMultiChildUpdateTypes.SET_MARKUP:setInnerHTML(n.parentNode,n.content);break;case ReactMultiChildUpdateTypes.TEXT_CONTENT:setTextContent(n.parentNode,n.content);break;case ReactMultiChildUpdateTypes.REMOVE_NODE:}}};ReactPerf.measureMethods(DOMChildrenOperations,"DOMChildrenOperations",{updateTextContent:"updateTextContent"}),module.exports=DOMChildrenOperations;

}).call(this,require('_process'))
},{"./Danger":38,"./ReactMultiChildUpdateTypes":96,"./ReactPerf":100,"./setInnerHTML":156,"./setTextContent":157,"_process":25,"fbjs/lib/invariant":177}],36:[function(require,module,exports){
(function (process){
"use strict";function checkMask(e,t){return(e&t)===t}var invariant=require("fbjs/lib/invariant"),DOMPropertyInjection={MUST_USE_ATTRIBUTE:1,MUST_USE_PROPERTY:2,HAS_SIDE_EFFECTS:4,HAS_BOOLEAN_VALUE:8,HAS_NUMERIC_VALUE:16,HAS_POSITIVE_NUMERIC_VALUE:48,HAS_OVERLOADED_BOOLEAN_VALUE:64,injectDOMPropertyConfig:function(e){var t=DOMPropertyInjection,r=e.Properties||{},o=e.DOMAttributeNamespaces||{},a=e.DOMAttributeNames||{},n=e.DOMPropertyNames||{},i=e.DOMMutationMethods||{};e.isCustomAttribute&&DOMProperty._isCustomAttributeFunctions.push(e.isCustomAttribute);for(var s in r){DOMProperty.properties.hasOwnProperty(s)&&("production"!==process.env.NODE_ENV?invariant(!1,"injectDOMPropertyConfig(...): You're trying to inject DOM property '%s' which has already been injected. You may be accidentally injecting the same DOM property config twice, or you may be injecting two configs that have conflicting property names.",s):invariant(!1));var u=s.toLowerCase(),c=r[s],p={attributeName:u,attributeNamespace:null,propertyName:s,mutationMethod:null,mustUseAttribute:checkMask(c,t.MUST_USE_ATTRIBUTE),mustUseProperty:checkMask(c,t.MUST_USE_PROPERTY),hasSideEffects:checkMask(c,t.HAS_SIDE_EFFECTS),hasBooleanValue:checkMask(c,t.HAS_BOOLEAN_VALUE),hasNumericValue:checkMask(c,t.HAS_NUMERIC_VALUE),hasPositiveNumericValue:checkMask(c,t.HAS_POSITIVE_NUMERIC_VALUE),hasOverloadedBooleanValue:checkMask(c,t.HAS_OVERLOADED_BOOLEAN_VALUE)};if(p.mustUseAttribute&&p.mustUseProperty&&("production"!==process.env.NODE_ENV?invariant(!1,"DOMProperty: Cannot require using both attribute and property: %s",s):invariant(!1)),!p.mustUseProperty&&p.hasSideEffects&&("production"!==process.env.NODE_ENV?invariant(!1,"DOMProperty: Properties that have side effects must use property: %s",s):invariant(!1)),p.hasBooleanValue+p.hasNumericValue+p.hasOverloadedBooleanValue<=1||("production"!==process.env.NODE_ENV?invariant(!1,"DOMProperty: Value can be one of boolean, overloaded boolean, or numeric value, but not a combination: %s",s):invariant(!1)),"production"!==process.env.NODE_ENV&&(DOMProperty.getPossibleStandardName[u]=s),a.hasOwnProperty(s)){var E=a[s];p.attributeName=E,"production"!==process.env.NODE_ENV&&(DOMProperty.getPossibleStandardName[E]=s)}o.hasOwnProperty(s)&&(p.attributeNamespace=o[s]),n.hasOwnProperty(s)&&(p.propertyName=n[s]),i.hasOwnProperty(s)&&(p.mutationMethod=i[s]),DOMProperty.properties[s]=p}}},defaultValueCache={},DOMProperty={ID_ATTRIBUTE_NAME:"data-reactid",properties:{},getPossibleStandardName:"production"!==process.env.NODE_ENV?{}:null,_isCustomAttributeFunctions:[],isCustomAttribute:function(e){for(var t=0;t<DOMProperty._isCustomAttributeFunctions.length;t++){if((0,DOMProperty._isCustomAttributeFunctions[t])(e))return!0}return!1},getDefaultValueForProperty:function(e,t){var r,o=defaultValueCache[e];return o||(defaultValueCache[e]=o={}),t in o||(r=document.createElement(e),o[t]=r[t]),o[t]},injection:DOMPropertyInjection};module.exports=DOMProperty;

}).call(this,require('_process'))
},{"_process":25,"fbjs/lib/invariant":177}],37:[function(require,module,exports){
(function (process){
"use strict";function isAttributeNameSafe(e){return!!validatedAttributeNameCache.hasOwnProperty(e)||!illegalAttributeNameCache.hasOwnProperty(e)&&(VALID_ATTRIBUTE_NAME_REGEX.test(e)?(validatedAttributeNameCache[e]=!0,!0):(illegalAttributeNameCache[e]=!0,"production"!==process.env.NODE_ENV&&warning(!1,"Invalid attribute name: `%s`",e),!1))}function shouldIgnoreValue(e,r){return null==r||e.hasBooleanValue&&!r||e.hasNumericValue&&isNaN(r)||e.hasPositiveNumericValue&&r<1||e.hasOverloadedBooleanValue&&!1===r}var DOMProperty=require("./DOMProperty"),ReactPerf=require("./ReactPerf"),quoteAttributeValueForBrowser=require("./quoteAttributeValueForBrowser"),warning=require("fbjs/lib/warning"),VALID_ATTRIBUTE_NAME_REGEX=/^[a-zA-Z_][\w\.\-]*$/,illegalAttributeNameCache={},validatedAttributeNameCache={};if("production"!==process.env.NODE_ENV)var reactProps={children:!0,dangerouslySetInnerHTML:!0,key:!0,ref:!0},warnedProperties={},warnUnknownProperty=function(e){if(!(reactProps.hasOwnProperty(e)&&reactProps[e]||warnedProperties.hasOwnProperty(e)&&warnedProperties[e])){warnedProperties[e]=!0;var r=e.toLowerCase(),t=DOMProperty.isCustomAttribute(r)?r:DOMProperty.getPossibleStandardName.hasOwnProperty(r)?DOMProperty.getPossibleStandardName[r]:null;"production"!==process.env.NODE_ENV&&warning(null==t,"Unknown DOM property %s. Did you mean %s?",e,t)}};var DOMPropertyOperations={createMarkupForID:function(e){return DOMProperty.ID_ATTRIBUTE_NAME+"="+quoteAttributeValueForBrowser(e)},setAttributeForID:function(e,r){e.setAttribute(DOMProperty.ID_ATTRIBUTE_NAME,r)},createMarkupForProperty:function(e,r){var t=DOMProperty.properties.hasOwnProperty(e)?DOMProperty.properties[e]:null;if(t){if(shouldIgnoreValue(t,r))return"";var o=t.attributeName;return t.hasBooleanValue||t.hasOverloadedBooleanValue&&!0===r?o+'=""':o+"="+quoteAttributeValueForBrowser(r)}return DOMProperty.isCustomAttribute(e)?null==r?"":e+"="+quoteAttributeValueForBrowser(r):("production"!==process.env.NODE_ENV&&warnUnknownProperty(e),null)},createMarkupForCustomAttribute:function(e,r){return isAttributeNameSafe(e)&&null!=r?e+"="+quoteAttributeValueForBrowser(r):""},setValueForProperty:function(e,r,t){var o=DOMProperty.properties.hasOwnProperty(r)?DOMProperty.properties[r]:null;if(o){var a=o.mutationMethod;if(a)a(e,t);else if(shouldIgnoreValue(o,t))this.deleteValueForProperty(e,r);else if(o.mustUseAttribute){var u=o.attributeName,i=o.attributeNamespace;i?e.setAttributeNS(i,u,""+t):o.hasBooleanValue||o.hasOverloadedBooleanValue&&!0===t?e.setAttribute(u,""):e.setAttribute(u,""+t)}else{var s=o.propertyName;o.hasSideEffects&&""+e[s]==""+t||(e[s]=t)}}else DOMProperty.isCustomAttribute(r)?DOMPropertyOperations.setValueForAttribute(e,r,t):"production"!==process.env.NODE_ENV&&warnUnknownProperty(r)},setValueForAttribute:function(e,r,t){isAttributeNameSafe(r)&&(null==t?e.removeAttribute(r):e.setAttribute(r,""+t))},deleteValueForProperty:function(e,r){var t=DOMProperty.properties.hasOwnProperty(r)?DOMProperty.properties[r]:null;if(t){var o=t.mutationMethod;if(o)o(e,void 0);else if(t.mustUseAttribute)e.removeAttribute(t.attributeName);else{var a=t.propertyName,u=DOMProperty.getDefaultValueForProperty(e.nodeName,a);t.hasSideEffects&&""+e[a]===u||(e[a]=u)}}else DOMProperty.isCustomAttribute(r)?e.removeAttribute(r):"production"!==process.env.NODE_ENV&&warnUnknownProperty(r)}};ReactPerf.measureMethods(DOMPropertyOperations,"DOMPropertyOperations",{setValueForProperty:"setValueForProperty",setValueForAttribute:"setValueForAttribute",deleteValueForProperty:"deleteValueForProperty"}),module.exports=DOMPropertyOperations;

}).call(this,require('_process'))
},{"./DOMProperty":36,"./ReactPerf":100,"./quoteAttributeValueForBrowser":154,"_process":25,"fbjs/lib/warning":188}],38:[function(require,module,exports){
(function (process){
"use strict";function getNodeName(e){return e.substring(1,e.indexOf(" "))}var ExecutionEnvironment=require("fbjs/lib/ExecutionEnvironment"),createNodesFromMarkup=require("fbjs/lib/createNodesFromMarkup"),emptyFunction=require("fbjs/lib/emptyFunction"),getMarkupWrap=require("fbjs/lib/getMarkupWrap"),invariant=require("fbjs/lib/invariant"),OPEN_TAG_NAME_EXP=/^(<[^ \/>]+)/,RESULT_INDEX_ATTR="data-danger-index",Danger={dangerouslyRenderMarkup:function(e){ExecutionEnvironment.canUseDOM||("production"!==process.env.NODE_ENV?invariant(!1,"dangerouslyRenderMarkup(...): Cannot render markup in a worker thread. Make sure `window` and `document` are available globally before requiring React when unit testing or use ReactDOMServer.renderToString for server rendering."):invariant(!1));for(var r,n={},a=0;a<e.length;a++)e[a]||("production"!==process.env.NODE_ENV?invariant(!1,"dangerouslyRenderMarkup(...): Missing markup."):invariant(!1)),r=getNodeName(e[a]),r=getMarkupWrap(r)?r:"*",n[r]=n[r]||[],n[r][a]=e[a];var t=[],i=0;for(r in n)if(n.hasOwnProperty(r)){var o,u=n[r];for(o in u)if(u.hasOwnProperty(o)){var s=u[o];u[o]=s.replace(OPEN_TAG_NAME_EXP,"$1 "+RESULT_INDEX_ATTR+'="'+o+'" ')}for(var d=createNodesFromMarkup(u.join(""),emptyFunction),p=0;p<d.length;++p){var c=d[p];c.hasAttribute&&c.hasAttribute(RESULT_INDEX_ATTR)?(o=+c.getAttribute(RESULT_INDEX_ATTR),c.removeAttribute(RESULT_INDEX_ATTR),t.hasOwnProperty(o)&&("production"!==process.env.NODE_ENV?invariant(!1,"Danger: Assigning to an already-occupied result index."):invariant(!1)),t[o]=c,i+=1):"production"!==process.env.NODE_ENV&&console.error("Danger: Discarding unexpected node:",c)}}return i!==t.length&&("production"!==process.env.NODE_ENV?invariant(!1,"Danger: Did not assign to every index of resultList."):invariant(!1)),t.length!==e.length&&("production"!==process.env.NODE_ENV?invariant(!1,"Danger: Expected markup to render %s nodes, but rendered %s.",e.length,t.length):invariant(!1)),t},dangerouslyReplaceNodeWithMarkup:function(e,r){ExecutionEnvironment.canUseDOM||("production"!==process.env.NODE_ENV?invariant(!1,"dangerouslyReplaceNodeWithMarkup(...): Cannot render markup in a worker thread. Make sure `window` and `document` are available globally before requiring React when unit testing or use ReactDOMServer.renderToString() for server rendering."):invariant(!1)),r||("production"!==process.env.NODE_ENV?invariant(!1,"dangerouslyReplaceNodeWithMarkup(...): Missing markup."):invariant(!1)),"html"===e.tagName.toLowerCase()&&("production"!==process.env.NODE_ENV?invariant(!1,"dangerouslyReplaceNodeWithMarkup(...): Cannot replace markup of the <html> node. This is because browser quirks make this unreliable and/or slow. If you want to render to the root you must use server rendering. See ReactDOMServer.renderToString()."):invariant(!1));var n;n="string"==typeof r?createNodesFromMarkup(r,emptyFunction)[0]:r,e.parentNode.replaceChild(n,e)}};module.exports=Danger;

}).call(this,require('_process'))
},{"_process":25,"fbjs/lib/ExecutionEnvironment":163,"fbjs/lib/createNodesFromMarkup":168,"fbjs/lib/emptyFunction":169,"fbjs/lib/getMarkupWrap":173,"fbjs/lib/invariant":177}],39:[function(require,module,exports){
...
},{"./EventConstants":41,"./EventPluginHub":42,"./accumulateInto":134,"./forEachAccumulated":142,"_process":25,"fbjs/lib/warning":188}],46:[function(require,module,exports){
...
},{"./ReactInstanceMap":91,"./findDOMNode":140,"_process":25,"fbjs/lib/warning":188}],53:[function(require,module,exports){
...
(function (process){
"use strict";function warnSetProps(){warnedSetProps||(warnedSetProps=!0,"production"!==process.env.NODE_ENV&&warning(!1,"setProps(...) and replaceProps(...) are deprecated. Instead, call render again at the top level."))}function validateTypeDef(e,t,n){for(var o in t)t.hasOwnProperty(o)&&"production"!==process.env.NODE_ENV&&warning("function"==typeof t[o],"%s: %s type `%s` is invalid; it must be a function, usually from React.PropTypes.",e.displayName||"ReactClass",ReactPropTypeLocationNames[n],o)}function validateMethodOverride(e,t){var n=ReactClassInterface.hasOwnProperty(t)?ReactClassInterface[t]:null;ReactClassMixin.hasOwnProperty(t)&&n!==SpecPolicy.OVERRIDE_BASE&&("production"!==process.env.NODE_ENV?invariant(!1,"ReactClassInterface: You are attempting to override `%s` from your class specification. Ensure that your method names do not overlap with React methods.",t):invariant(!1)),e.hasOwnProperty(t)&&n!==SpecPolicy.DEFINE_MANY&&n!==SpecPolicy.DEFINE_MANY_MERGED&&("production"!==process.env.NODE_ENV?invariant(!1,"ReactClassInterface: You are attempting to define `%s` on your component more than once. This conflict may be due to a mixin.",t):invariant(!1))}function mixSpecIntoComponent(e,t){if(t){"function"==typeof t&&("production"!==process.env.NODE_ENV?invariant(!1,"ReactClass: You're attempting to use a component class as a mixin. Instead, just use a regular object."):invariant(!1)),ReactElement.isValidElement(t)&&("production"!==process.env.NODE_ENV?invariant(!1,"ReactClass: You're attempting to use a component as a mixin. Instead, just use a regular object."):invariant(!1));var n=e.prototype;t.hasOwnProperty(MIXINS_KEY)&&RESERVED_SPEC_KEYS.mixins(e,t.mixins);for(var o in t)if(t.hasOwnProperty(o)&&o!==MIXINS_KEY){var i=t[o];if(validateMethodOverride(n,o),RESERVED_SPEC_KEYS.hasOwnProperty(o))RESERVED_SPEC_KEYS[o](e,i);else{var a=ReactClassInterface.hasOwnProperty(o),r=n.hasOwnProperty(o),s="function"==typeof i,c=s&&!a&&!r&&!1!==t.autobind;if(c)n.__reactAutoBindMap||(n.__reactAutoBindMap={}),n.__reactAutoBindMap[o]=i,n[o]=i;else if(r){var p=ReactClassInterface[o];(!a||p!==SpecPolicy.DEFINE_MANY_MERGED&&p!==SpecPolicy.DEFINE_MANY)&&("production"!==process.env.NODE_ENV?invariant(!1,"ReactClass: Unexpected spec policy %s for key %s when mixing in component specs.",p,o):invariant(!1)),p===SpecPolicy.DEFINE_MANY_MERGED?n[o]=createMergedResultFunction(n[o],i):p===SpecPolicy.DEFINE_MANY&&(n[o]=createChainedFunction(n[o],i))}else n[o]=i,"production"!==process.env.NODE_ENV&&"function"==typeof i&&t.displayName&&(n[o].displayName=t.displayName+"_"+o)}}}}function mixStaticSpecIntoComponent(e,t){if(t)for(var n in t){var o=t[n];if(t.hasOwnProperty(n)){var i=n in RESERVED_SPEC_KEYS;i&&("production"!==process.env.NODE_ENV?invariant(!1,'ReactClass: You are attempting to define a reserved property, `%s`, that shouldn\'t be on the "statics" key. Define it as an instance property instead; it will still be accessible on the constructor.',n):invariant(!1));var a=n in e;a&&("production"!==process.env.NODE_ENV?invariant(!1,"ReactClass: You are attempting to define `%s` on your component more than once. This conflict may be due to a mixin.",n):invariant(!1)),e[n]=o}}}function mergeIntoWithNoDuplicateKeys(e,t){e&&t&&"object"==typeof e&&"object"==typeof t||("production"!==process.env.NODE_ENV?invariant(!1,"mergeIntoWithNoDuplicateKeys(): Cannot merge non-objects."):invariant(!1));for(var n in t)t.hasOwnProperty(n)&&(void 0!==e[n]&&("production"!==process.env.NODE_ENV?invariant(!1,"mergeIntoWithNoDuplicateKeys(): Tried to merge two objects with the same key: `%s`. This conflict may be due to a mixin; in particular, this may be caused by two getInitialState() or getDefaultProps() methods returning objects with clashing keys.",n):invariant(!1)),e[n]=t[n]);return e}function createMergedResultFunction(e,t){return function(){var n=e.apply(this,arguments),o=t.apply(this,arguments);if(null==n)return o;if(null==o)return n;var i={};return mergeIntoWithNoDuplicateKeys(i,n),mergeIntoWithNoDuplicateKeys(i,o),i}}function createChainedFunction(e,t){return function(){e.apply(this,arguments),t.apply(this,arguments)}}function bindAutoBindMethod(e,t){var n=t.bind(e);if("production"!==process.env.NODE_ENV){n.__reactBoundContext=e,n.__reactBoundMethod=t,n.__reactBoundArguments=null;var o=e.constructor.displayName,i=n.bind;n.bind=function(a){for(var r=arguments.length,s=Array(r>1?r-1:0),c=1;c<r;c++)s[c-1]=arguments[c];if(a!==e&&null!==a)"production"!==process.env.NODE_ENV&&warning(!1,"bind(): React component methods may only be bound to the component instance. See %s",o);else if(!s.length)return"production"!==process.env.NODE_ENV&&warning(!1,"bind(): You are binding a component method to the component. React does this for you automatically in a high-performance way, so you can safely remove this call. See %s",o),n;var p=i.apply(n,arguments);return p.__reactBoundContext=e,p.__reactBoundMethod=t,p.__reactBoundArguments=s,p}}return n}function bindAutoBindMethods(e){for(var t in e.__reactAutoBindMap)if(e.__reactAutoBindMap.hasOwnProperty(t)){var n=e.__reactAutoBindMap[t];e[t]=bindAutoBindMethod(e,n)}}var ReactComponent=require("./ReactComponent"),ReactElement=require("./ReactElement"),ReactPropTypeLocations=require("./ReactPropTypeLocations"),ReactPropTypeLocationNames=require("./ReactPropTypeLocationNames"),ReactNoopUpdateQueue=require("./ReactNoopUpdateQueue"),assign=require("./Object.assign"),emptyObject=require("fbjs/lib/emptyObject"),invariant=require("fbjs/lib/invariant"),keyMirror=require("fbjs/lib/keyMirror"),keyOf=require("fbjs/lib/keyOf"),warning=require("fbjs/lib/warning"),MIXINS_KEY=keyOf({mixins:null}),SpecPolicy=keyMirror({DEFINE_ONCE:null,DEFINE_MANY:null,OVERRIDE_BASE:null,DEFINE_MANY_MERGED:null}),injectedMixins=[],warnedSetProps=!1,ReactClassInterface={mixins:SpecPolicy.DEFINE_MANY,statics:SpecPolicy.DEFINE_MANY,propTypes:SpecPolicy.DEFINE_MANY,contextTypes:SpecPolicy.DEFINE_MANY,childContextTypes:SpecPolicy.DEFINE_MANY,getDefaultProps:SpecPolicy.DEFINE_MANY_MERGED,getInitialState:SpecPolicy.DEFINE_MANY_MERGED,getChildContext:SpecPolicy.DEFINE_MANY_MERGED,render:SpecPolicy.DEFINE_ONCE,componentWillMount:SpecPolicy.DEFINE_MANY,componentDidMount:SpecPolicy.DEFINE_MANY,componentWillReceiveProps:SpecPolicy.DEFINE_MANY,shouldComponentUpdate:SpecPolicy.DEFINE_ONCE,componentWillUpdate:SpecPolicy.DEFINE_MANY,componentDidUpdate:SpecPolicy.DEFINE_MANY,componentWillUnmount:SpecPolicy.DEFINE_MANY,updateComponent:SpecPolicy.OVERRIDE_BASE},RESERVED_SPEC_KEYS={displayName:function(e,t){e.displayName=t},mixins:function(e,t){if(t)for(var n=0;n<t.length;n++)mixSpecIntoComponent(e,t[n])},childContextTypes:function(e,t){"production"!==process.env.NODE_ENV&&validateTypeDef(e,t,ReactPropTypeLocations.childContext),e.childContextTypes=assign({},e.childContextTypes,t)},contextTypes:function(e,t){"production"!==process.env.NODE_ENV&&validateTypeDef(e,t,ReactPropTypeLocations.context),e.contextTypes=assign({},e.contextTypes,t)},getDefaultProps:function(e,t){e.getDefaultProps?e.getDefaultProps=createMergedResultFunction(e.getDefaultProps,t):e.getDefaultProps=t},propTypes:function(e,t){"production"!==process.env.NODE_ENV&&validateTypeDef(e,t,ReactPropTypeLocations.prop),e.propTypes=assign({},e.propTypes,t)},statics:function(e,t){mixStaticSpecIntoComponent(e,t)},autobind:function(){}},ReactClassMixin={replaceState:function(e,t){this.updater.enqueueReplaceState(this,e),t&&this.updater.enqueueCallback(this,t)},isMounted:function(){return this.updater.isMounted(this)},setProps:function(e,t){"production"!==process.env.NODE_ENV&&warnSetProps(),this.updater.enqueueSetProps(this,e),t&&this.updater.enqueueCallback(this,t)},replaceProps:function(e,t){"production"!==process.env.NODE_ENV&&warnSetProps(),this.updater.enqueueReplaceProps(this,e),t&&this.updater.enqueueCallback(this,t)}},ReactClassComponent=function(){};assign(ReactClassComponent.prototype,ReactComponent.prototype,ReactClassMixin);var ReactClass={createClass:function(e){var t=function(e,n,o){"production"!==process.env.NODE_ENV&&"production"!==process.env.NODE_ENV&&warning(this instanceof t,"Something is calling a React component directly. Use a factory or JSX instead. See: https://fb.me/react-legacyfactory"),this.__reactAutoBindMap&&bindAutoBindMethods(this),this.props=e,this.context=n,this.refs=emptyObject,this.updater=o||ReactNoopUpdateQueue,this.state=null;var i=this.getInitialState?this.getInitialState():null;"production"!==process.env.NODE_ENV&&void 0===i&&this.getInitialState._isMockFunction&&(i=null),("object"!=typeof i||Array.isArray(i))&&("production"!==process.env.NODE_ENV?invariant(!1,"%s.getInitialState(): must return an object or null",t.displayName||"ReactCompositeComponent"):invariant(!1)),this.state=i};t.prototype=new ReactClassComponent,t.prototype.constructor=t,injectedMixins.forEach(mixSpecIntoComponent.bind(null,t)),mixSpecIntoComponent(t,e),t.getDefaultProps&&(t.defaultProps=t.getDefaultProps()),"production"!==process.env.NODE_ENV&&(t.getDefaultProps&&(t.getDefaultProps.isReactClassApproved={}),t.prototype.getInitialState&&(t.prototype.getInitialState.isReactClassApproved={})),t.prototype.render||("production"!==process.env.NODE_ENV?invariant(!1,"createClass(...): Class specification must implement a `render` method."):invariant(!1)),"production"!==process.env.NODE_ENV&&("production"!==process.env.NODE_ENV&&warning(!t.prototype.componentShouldUpdate,"%s has a method called componentShouldUpdate(). Did you mean shouldComponentUpdate()? The name is phrased as a question because the function is expected to return a value.",e.displayName||"A component"),"production"!==process.env.NODE_ENV&&warning(!t.prototype.componentWillRecieveProps,"%s has a method called componentWillRecieveProps(). Did you mean componentWillReceiveProps()?",e.displayName||"A component"));for(var n in ReactClassInterface)t.prototype[n]||(t.prototype[n]=null);return t},injection:{injectMixin:function(e){injectedMixins.push(e)}}};module.exports=ReactClass;

}).call(this,require('_process'))
},{"./Object.assign":49,"./ReactComponent":59,"./ReactElement":81,"./ReactNoopUpdateQueue":98,"./ReactPropTypeLocationNames":101,"./ReactPropTypeLocations":102,"_process":25,"fbjs/lib/emptyObject":170,"fbjs/lib/invariant":177,"fbjs/lib/keyMirror":180,"fbjs/lib/keyOf":181,"fbjs/lib/warning":188}],59:[function(require,module,exports){
(function (process){
"use strict";function ReactComponent(e,t,n){this.props=e,this.context=t,this.refs=emptyObject,this.updater=n||ReactNoopUpdateQueue}var ReactNoopUpdateQueue=require("./ReactNoopUpdateQueue"),canDefineProperty=require("./canDefineProperty"),emptyObject=require("fbjs/lib/emptyObject"),invariant=require("fbjs/lib/invariant"),warning=require("fbjs/lib/warning");if(ReactComponent.prototype.isReactComponent={},ReactComponent.prototype.setState=function(e,t){"object"!=typeof e&&"function"!=typeof e&&null!=e&&("production"!==process.env.NODE_ENV?invariant(!1,"setState(...): takes an object of state variables to update or a function which returns an object of state variables."):invariant(!1)),"production"!==process.env.NODE_ENV&&"production"!==process.env.NODE_ENV&&warning(null!=e,"setState(...): You passed an undefined or null state object; instead, use forceUpdate()."),this.updater.enqueueSetState(this,e),t&&this.updater.enqueueCallback(this,t)},ReactComponent.prototype.forceUpdate=function(e){this.updater.enqueueForceUpdate(this),e&&this.updater.enqueueCallback(this,e)},"production"!==process.env.NODE_ENV){var deprecatedAPIs={getDOMNode:["getDOMNode","Use ReactDOM.findDOMNode(component) instead."],isMounted:["isMounted","Instead, make sure to clean up subscriptions and pending requests in componentWillUnmount to prevent memory leaks."],replaceProps:["replaceProps","Instead, call render again at the top level."],replaceState:["replaceState","Refactor your code to use setState instead (see https://github.com/facebook/react/issues/3236)."],setProps:["setProps","Instead, call render again at the top level."]},defineDeprecationWarning=function(e,t){canDefineProperty&&Object.defineProperty(ReactComponent.prototype,e,{get:function(){"production"!==process.env.NODE_ENV&&warning(!1,"%s(...) is deprecated in plain JavaScript React classes. %s",t[0],t[1])}})};for(var fnName in deprecatedAPIs)deprecatedAPIs.hasOwnProperty(fnName)&&defineDeprecationWarning(fnName,deprecatedAPIs[fnName])}module.exports=ReactComponent;

}).call(this,require('_process'))
},{"./ReactNoopUpdateQueue":98,"./canDefineProperty":136,"_process":25,"fbjs/lib/emptyObject":170,"fbjs/lib/invariant":177,"fbjs/lib/warning":188}],60:[function(require,module,exports){
...
},{"./ReactCurrentOwner":63,"./ReactDOMTextComponent":75,"./ReactDefaultInjection":78,"./ReactInstanceHandles":90,"./ReactMount":94,"./ReactPerf":100,"./ReactReconciler":105,"./ReactUpdates":115,"./ReactVersion":116,"./findDOMNode":140,"./renderSubtreeIntoContainer":155,"_process":25,"fbjs/lib/ExecutionEnvironment":163,"fbjs/lib/warning":188}],65:[function(require,module,exports){
...
},{"./DOMChildrenOperations":35,"./DOMPropertyOperations":37,"./Object.assign":49,"./ReactComponentBrowserEnvironment":60,"./ReactMount":94,"./escapeTextContentForBrowser":139,"./setTextContent":157,"./validateDOMNesting":160,"_process":25}],76:[function(require,module,exports){
(function (process){
"use strict";function forceUpdateIfMounted(){this._rootNodeID&&ReactDOMTextarea.updateWrapper(this)}function _handleChange(e){var a=this._currentElement.props,n=LinkedValueUtils.executeOnChange(a,e);return ReactUpdates.asap(forceUpdateIfMounted,this),n}var LinkedValueUtils=require("./LinkedValueUtils"),ReactDOMIDOperations=require("./ReactDOMIDOperations"),ReactUpdates=require("./ReactUpdates"),assign=require("./Object.assign"),invariant=require("fbjs/lib/invariant"),warning=require("fbjs/lib/warning"),ReactDOMTextarea={getNativeProps:function(e,a,n){return null!=a.dangerouslySetInnerHTML&&("production"!==process.env.NODE_ENV?invariant(!1,"`dangerouslySetInnerHTML` does not make sense on <textarea>."):invariant(!1)),assign({},a,{defaultValue:void 0,value:void 0,children:e._wrapperState.initialValue,onChange:e._wrapperState.onChange})},mountWrapper:function(e,a){"production"!==process.env.NODE_ENV&&LinkedValueUtils.checkPropTypes("textarea",a,e._currentElement._owner);var n=a.defaultValue,t=a.children;null!=t&&("production"!==process.env.NODE_ENV&&"production"!==process.env.NODE_ENV&&warning(!1,"Use the `defaultValue` or `value` props instead of setting children on <textarea>."),null!=n&&("production"!==process.env.NODE_ENV?invariant(!1,"If you supply `defaultValue` on a <textarea>, do not pass children."):invariant(!1)),Array.isArray(t)&&(t.length<=1||("production"!==process.env.NODE_ENV?invariant(!1,"<textarea> can only have at most one child."):invariant(!1)),t=t[0]),n=""+t),null==n&&(n="");var r=LinkedValueUtils.getValue(a);e._wrapperState={initialValue:""+(null!=r?r:n),onChange:_handleChange.bind(e)}},updateWrapper:function(e){var a=e._currentElement.props,n=LinkedValueUtils.getValue(a);null!=n&&ReactDOMIDOperations.updatePropertyByID(e._rootNodeID,"value",""+n)}};module.exports=ReactDOMTextarea;

}).call(this,require('_process'))
},{"./LinkedValueUtils":48,"./Object.assign":49,"./ReactDOMIDOperations":69,"./ReactUpdates":115,"_process":25,"fbjs/lib/invariant":177,"fbjs/lib/warning":188}],77:[function(require,module,exports){
...
(function (process){
"use strict";function getReactRootIDString(t){return SEPARATOR+t.toString(36)}function isBoundary(t,e){return t.charAt(e)===SEPARATOR||e===t.length}function isValidID(t){return""===t||t.charAt(0)===SEPARATOR&&t.charAt(t.length-1)!==SEPARATOR}function isAncestorIDOf(t,e){return 0===e.indexOf(t)&&isBoundary(e,t.length)}function getParentID(t){return t?t.substr(0,t.lastIndexOf(SEPARATOR)):""}function getNextDescendantID(t,e){if(isValidID(t)&&isValidID(e)||("production"!==process.env.NODE_ENV?invariant(!1,"getNextDescendantID(%s, %s): Received an invalid React DOM ID.",t,e):invariant(!1)),isAncestorIDOf(t,e)||("production"!==process.env.NODE_ENV?invariant(!1,"getNextDescendantID(...): React has made an invalid assumption about the DOM hierarchy. Expected `%s` to be an ancestor of `%s`.",t,e):invariant(!1)),t===e)return t;var n,r=t.length+SEPARATOR_LENGTH;for(n=r;n<e.length&&!isBoundary(e,n);n++);return e.substr(0,n)}function getFirstCommonAncestorID(t,e){var n=Math.min(t.length,e.length);if(0===n)return"";for(var r=0,a=0;a<=n;a++)if(isBoundary(t,a)&&isBoundary(e,a))r=a;else if(t.charAt(a)!==e.charAt(a))break;var s=t.substr(0,r);return isValidID(s)||("production"!==process.env.NODE_ENV?invariant(!1,"getFirstCommonAncestorID(%s, %s): Expected a valid React DOM ID: %s",t,e,s):invariant(!1)),s}function traverseParentPath(t,e,n,r,a,s){t=t||"",e=e||"",t===e&&("production"!==process.env.NODE_ENV?invariant(!1,"traverseParentPath(...): Cannot traverse from and to the same ID, `%s`.",t):invariant(!1));var i=isAncestorIDOf(e,t);i||isAncestorIDOf(t,e)||("production"!==process.env.NODE_ENV?invariant(!1,"traverseParentPath(%s, %s, ...): Cannot traverse from two IDs that do not have a parent path.",t,e):invariant(!1));for(var o=0,c=i?getParentID:getNextDescendantID,v=t;;v=c(v,e)){var D;if(a&&v===t||s&&v===e||(D=n(v,i,r)),!1===D||v===e)break;o++<MAX_TREE_DEPTH||("production"!==process.env.NODE_ENV?invariant(!1,"traverseParentPath(%s, %s, ...): Detected an infinite loop while traversing the React DOM ID tree. This may be due to malformed IDs: %s",t,e,v):invariant(!1))}}var ReactRootIndex=require("./ReactRootIndex"),invariant=require("fbjs/lib/invariant"),SEPARATOR=".",SEPARATOR_LENGTH=SEPARATOR.length,MAX_TREE_DEPTH=1e4,ReactInstanceHandles={createReactRootID:function(){return getReactRootIDString(ReactRootIndex.createReactRootIndex())},createReactID:function(t,e){return t+e},getReactRootIDFromNodeID:function(t){if(t&&t.charAt(0)===SEPARATOR&&t.length>1){var e=t.indexOf(SEPARATOR,1);return e>-1?t.substr(0,e):t}return null},traverseEnterLeave:function(t,e,n,r,a){var s=getFirstCommonAncestorID(t,e);s!==t&&traverseParentPath(t,s,n,r,!1,!0),s!==e&&traverseParentPath(s,e,n,a,!0,!1)},traverseTwoPhase:function(t,e,n){t&&(traverseParentPath("",t,e,n,!0,!1),traverseParentPath(t,"",e,n,!1,!0))},traverseTwoPhaseSkipTarget:function(t,e,n){t&&(traverseParentPath("",t,e,n,!0,!0),traverseParentPath(t,"",e,n,!0,!0))},traverseAncestors:function(t,e,n){traverseParentPath("",t,e,n,!0,!1)},getFirstCommonAncestorID:getFirstCommonAncestorID,_getNextDescendantID:getNextDescendantID,isAncestorIDOf:isAncestorIDOf,SEPARATOR:SEPARATOR};module.exports=ReactInstanceHandles;

}).call(this,require('_process'))
},{"./ReactRootIndex":107,"_process":25,"fbjs/lib/invariant":177}],91:[function(require,module,exports){
...
},{"./Object.assign":49,"./ReactChildren":57,"./ReactClass":58,"./ReactComponent":59,"./ReactDOMFactories":67,"./ReactElement":81,"./ReactElementValidator":82,"./ReactPropTypes":103,"./ReactVersion":116,"./onlyChild":153,"_process":25}],93:[function(require,module,exports){
...
},{"./ReactChildReconciler":56,"./ReactComponentEnvironment":61,"./ReactCurrentOwner":63,"./ReactMultiChildUpdateTypes":96,"./ReactReconciler":105,"./flattenChildren":141,"_process":25}],96:[function(require,module,exports){
...
(function (process){
"use strict";var invariant=require("fbjs/lib/invariant"),Mixin={reinitializeTransaction:function(){this.transactionWrappers=this.getTransactionWrappers(),this.wrapperInitData?this.wrapperInitData.length=0:this.wrapperInitData=[],this._isInTransaction=!1},_isInTransaction:!1,getTransactionWrappers:null,isInTransaction:function(){return!!this._isInTransaction},perform:function(i,n,a,t,r,s,e,l){this.isInTransaction()&&("production"!==process.env.NODE_ENV?invariant(!1,"Transaction.perform(...): Cannot initialize a transaction when there is already an outstanding transaction."):invariant(!1));var o,c;try{this._isInTransaction=!0,o=!0,this.initializeAll(0),c=i.call(n,a,t,r,s,e,l),o=!1}finally{try{if(o)try{this.closeAll(0)}catch(i){}else this.closeAll(0)}finally{this._isInTransaction=!1}}return c},initializeAll:function(i){for(var n=this.transactionWrappers,a=i;a<n.length;a++){var t=n[a];try{this.wrapperInitData[a]=Transaction.OBSERVED_ERROR,this.wrapperInitData[a]=t.initialize?t.initialize.call(this):null}finally{if(this.wrapperInitData[a]===Transaction.OBSERVED_ERROR)try{this.initializeAll(a+1)}catch(i){}}}},closeAll:function(i){this.isInTransaction()||("production"!==process.env.NODE_ENV?invariant(!1,"Transaction.closeAll(): Cannot close transaction when none are open."):invariant(!1));for(var n=this.transactionWrappers,a=i;a<n.length;a++){var t,r=n[a],s=this.wrapperInitData[a];try{t=!0,s!==Transaction.OBSERVED_ERROR&&r.close&&r.close.call(this,s),t=!1}finally{if(t)try{this.closeAll(a+1)}catch(i){}}}this.wrapperInitData.length=0}},Transaction={Mixin:Mixin,OBSERVED_ERROR:{}};module.exports=Transaction;

}).call(this,require('_process'))
},{"_process":25,"fbjs/lib/invariant":177}],133:[function(require,module,exports){
...
(function (process){
"use strict";function deprecated(e,r,s,n,i){var t=!1;if("production"!==process.env.NODE_ENV){return assign(function(){return"production"!==process.env.NODE_ENV&&warning(t,"React.%s is deprecated. Please use %s.%s from require('%s') instead.",e,r,e,s),t=!0,i.apply(n,arguments)},i)}return i}var assign=require("./Object.assign"),warning=require("fbjs/lib/warning");module.exports=deprecated;

}).call(this,require('_process'))
},{"./Object.assign":49,"_process":25,"fbjs/lib/warning":188}],139:[function(require,module,exports){
...
(function (process){
"use strict";function getDeclarationErrorAddendum(e){if(e){var n=e.getName();if(n)return" Check the render method of `"+n+"`."}return""}function isInternalComponentType(e){return"function"==typeof e&&void 0!==e.prototype&&"function"==typeof e.prototype.mountComponent&&"function"==typeof e.prototype.receiveComponent}function instantiateReactComponent(e){var n;if(null===e||!1===e)n=new ReactEmptyComponent(instantiateReactComponent);else if("object"==typeof e){var t=e;(!t||"function"!=typeof t.type&&"string"!=typeof t.type)&&("production"!==process.env.NODE_ENV?invariant(!1,"Element type is invalid: expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s",null==t.type?t.type:typeof t.type,getDeclarationErrorAddendum(t._owner)):invariant(!1)),n="string"==typeof t.type?ReactNativeComponent.createInternalComponent(t):isInternalComponentType(t.type)?new t.type(t):new ReactCompositeComponentWrapper}else"string"==typeof e||"number"==typeof e?n=ReactNativeComponent.createInstanceForText(e):"production"!==process.env.NODE_ENV?invariant(!1,"Encountered invalid React node of type %s",typeof e):invariant(!1);return"production"!==process.env.NODE_ENV&&"production"!==process.env.NODE_ENV&&warning("function"==typeof n.construct&&"function"==typeof n.mountComponent&&"function"==typeof n.receiveComponent&&"function"==typeof n.unmountComponent,"Only React Components can be mounted."),n.construct(e),n._mountIndex=0,n._mountImage=null,"production"!==process.env.NODE_ENV&&(n._isOwnerNecessary=!1,n._warnedAboutRefsInRender=!1),"production"!==process.env.NODE_ENV&&Object.preventExtensions&&Object.preventExtensions(n),n}var ReactCompositeComponent=require("./ReactCompositeComponent"),ReactEmptyComponent=require("./ReactEmptyComponent"),ReactNativeComponent=require("./ReactNativeComponent"),assign=require("./Object.assign"),invariant=require("fbjs/lib/invariant"),warning=require("fbjs/lib/warning"),ReactCompositeComponentWrapper=function(){};assign(ReactCompositeComponentWrapper.prototype,ReactCompositeComponent.Mixin,{_instantiateReactComponent:instantiateReactComponent}),module.exports=instantiateReactComponent;

}).call(this,require('_process'))
},{"./Object.assign":49,"./ReactCompositeComponent":62,"./ReactEmptyComponent":83,"./ReactNativeComponent":97,"_process":25,"fbjs/lib/invariant":177,"fbjs/lib/warning":188}],151:[function(require,module,exports){
...
(function (process){
"use strict";function onlyChild(e){return ReactElement.isValidElement(e)||("production"!==process.env.NODE_ENV?invariant(!1,"onlyChild must be passed a children with exactly one child."):invariant(!1)),e}var ReactElement=require("./ReactElement"),invariant=require("fbjs/lib/invariant");module.exports=onlyChild;

}).call(this,require('_process'))
},{"./ReactElement":81,"_process":25,"fbjs/lib/invariant":177}],154:[function(require,module,exports){
...
},{"./emptyFunction":169,"_process":25}],163:[function(require,module,exports){
...
},{"./ExecutionEnvironment":163,"./createArrayFromMixed":167,"./getMarkupWrap":173,"./invariant":177,"_process":25}],169:[function(require,module,exports){
...
},{"./ExecutionEnvironment":163,"./invariant":177,"_process":25}],174:[function(require,module,exports){
...
},{"_process":25}],178:[function(require,module,exports){
...
(function (process){
"use strict";var invariant=require("./invariant"),keyMirror=function(r){var n,i={};r instanceof Object&&!Array.isArray(r)||("production"!==process.env.NODE_ENV?invariant(!1,"keyMirror(...): Argument must be an object."):invariant(!1));for(n in r)r.hasOwnProperty(n)&&(i[n]=n);return i};module.exports=keyMirror;

}).call(this,require('_process'))
},{"./invariant":177,"_process":25}],181:[function(require,module,exports){
...
(function (process){
"use strict";function toArray(r){var t=r.length;if((Array.isArray(r)||"object"!=typeof r&&"function"!=typeof r)&&("production"!==process.env.NODE_ENV?invariant(!1,"toArray: Array-like object expected"):invariant(!1)),"number"!=typeof t&&("production"!==process.env.NODE_ENV?invariant(!1,"toArray: Object needs a length property"):invariant(!1)),0===t||t-1 in r||("production"!==process.env.NODE_ENV?invariant(!1,"toArray: Object should have keys for indices"):invariant(!1)),r.hasOwnProperty)try{return Array.prototype.slice.call(r)}catch(r){}for(var e=Array(t),n=0;n<t;n++)e[n]=r[n];return e}var invariant=require("./invariant");module.exports=toArray;
}).call(this,require('_process'))
},{"./invariant":177,"_process":25}],188:[function(require,module,exports){
(function (process){
"use strict";var emptyFunction=require("./emptyFunction"),warning=emptyFunction;"production"!==process.env.NODE_ENV&&(warning=function(r,n){for(var e=arguments.length,o=Array(e>2?e-2:0),i=2;i<e;i++)o[i-2]=arguments[i];if(void 0===n)throw new Error("`warning(condition, format, ...args)` requires a warning message argument");if(0!==n.indexOf("Failed Composite propType: ")&&!r){var t=0,a="Warning: "+n.replace(/%s/g,function(){return o[t++]});"undefined"!=typeof console&&console.error(a);try{throw new Error(a)}catch(r){}}}),module.exports=warning;

}).call(this,require('_process'))
},{"./emptyFunction":169,"_process":25}],189:[function(require,module,exports){
