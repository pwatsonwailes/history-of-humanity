...
function isset(t){return"undefined"!=typeof t}var React=require("react/addons"),ItemList=React.createClass({displayName:"ItemList",jumping:!1,getInitialState:function(){return{jumpTo:!1}},componentWillReceiveProps:function(t){(this.props.highlightLatLong===!1&&t.highlightLatLong!==!1||this.props.highlightLatLong.lat!==t.highlightLatLong.lat)&&this.setState({jumpTo:!1})},scrollAnimate:function(t,e){function i(t,e){return e>t?t:e}function a(o){var l=Date.now(),h=i(1,(l-s)/e),p=.5>h?2*h*h:-1+(4-2*h)*h;r.scrollTop=p*(t-n)+n,1>h&&requestAnimationFrame(a)}var s=Date.now(),r=document.documentElement.scrollTop?document.documentElement:document.body,n=r.scrollTop;n!==t&&requestAnimationFrame(a)},renderYear:function(t,e,i){return React.createElement("li",{key:"year"+t+e+i,className:"yearTitle"},i)},renderItemThumbnail:function(t,e){var i="thumb"+e;return isset(t.thumbnail)&&""!==t.thumbnail?React.createElement("img",{key:i,className:"thumbnail",src:t.thumbnail}):[]},renderItem:function(t,e){var e,i,a,s=0;for(e=0,a=t.text.length;a>e;e++)i=t.text.charCodeAt(e),s=(s<<5)-s+i,s|=0;var r=this.renderItemThumbnail(t,s),n="itemPanel",o=isset(this.props.highlightLatLong)&&isset(this.props.highlightLatLong.lat)&&isset(this.props.highlightLatLong["long"]),l=isset(t.latlong)&&isset(t.latlong[0])&&isset(t.latlong[0][0]);if(o&&l){var h=t.latlong[0][0].toFixed(1),p=t.latlong[0][1].toFixed(1);h===this.props.highlightLatLong.lat&&p===this.props.highlightLatLong["long"]&&(n+=" highlightMap",this.state.jumpTo===!1&&this.jumping===!1&&(this.jumping=!0,this.scrollAnimate($(s).offsetTop,1e3)))}parseInt(this.state.jumpTo)===parseInt(s)&&(n+=" highlightClick");var m=t.links.main.link.replace("//en.wikipedia.org/wiki/","");return React.createElement("li",{key:s,id:s,"data-year":t.year,"data-position":t.position,className:n,onClick:this.itemHandler},r,React.createElement("p",null,React.createElement("a",{href:"/history-of-humanity/"+t.year+"/"+t.position+"/"+m},t.text)),React.createElement("div",{className:"readmore"},React.createElement("span",{"data-year":t.year,"data-position":t.position},"Read more...")))},itemHandler:function(t){if(isset(t.target.id)&&""!==t.target.id)var e=t.target.id;else if(isset(t.target.parentNode.id)&&""!==t.target.parentNode.id)var e=t.target.parentNode.id;else if(isset(t.target.parentNode.parentNode.id)&&""!==t.target.parentNode.parentNode.id)var e=t.target.parentNode.parentNode.id;(this.state.jumpTo===!1||parseInt(this.state.jumpTo)!==parseInt(e))&&(this.scrollAnimate($(e).offsetTop,1e3),this.setState({jumpTo:e})),this.props.itemHandler(t)},renderItems:function(t){var e=[];if(this.props.items.length>0){var i=this.props.pointer*this.props.show,a=this.props.pointer*this.props.show+this.props.show,s=this.props.items[i].year;e.push(this.renderYear(i,a,this.props.items[i].year));for(var r=i;a>r;r++)isset(this.props.items[r])&&(this.props.items[r].year!==s&&(e.push(this.renderYear(r,a,this.props.items[r].year)),s=this.props.items[r].year),e.push(this.renderItem(this.props.items[r],r)))}return this.jumping=!1,e},loadingItems:function(){return React.createElement("li",{className:"yearTitle"},"Loading data")},noItems:function(){return React.createElement("li",{className:"yearTitle"},"No data for your selection")},render:function(){if(this.props.items===!1)var t=this.loadingItems();else if(this.props.items.length>0)var t=this.renderItems();else var t=this.noItems();return React.createElement("div",{id:"items"},React.createElement("ul",null,t))}});module.exports=ItemList;

},{"react/addons":27}],8:[function(require,module,exports){
var React=require("react/addons");Pagination=React.createClass({displayName:"Pagination",updateArr:function(){var e=[];if(this.props.maxBlocks-this.props.nPages<2){maxPivotPages=Math.round((this.props.maxBlocks-5)/2),minPage=Math.max(0,this.props.pointer-maxPivotPages),maxPage=Math.min(this.props.nPages-1,this.props.pointer+2*maxPivotPages-(this.props.pointer-minPage)),minPage=Math.max(0,minPage-(2*maxPivotPages-(maxPage-minPage)));var a=!0}else{minPage=0,maxPage=this.props.nPages-1;var a=!1}a&&0!==minPage&&(e[0]="prev",e[1]="hellip1");for(var i=minPage;i<=maxPage;i++)e.push(i);return a&&this.props.nPages!==maxPage+1&&(e.push("hellip2"),e.push("next")),e},paginationItems:function(e){var a=this.props.pointer===e?"selected clickable":"clickable";if("prev"===e)return React.createElement("li",{key:e,className:a,onClick:this.props.clickHandler.bind(null,0)},"1");if("next"===e)return React.createElement("li",{key:e,className:a,onClick:this.props.clickHandler.bind(null,this.props.nPages-1)},this.props.nPages);if("hellip1"===e||"hellip2"===e)return React.createElement("li",{key:e,className:"more"},"...");var i=e+1;return React.createElement("li",{key:e,className:a,onClick:this.props.clickHandler.bind(null,e)},i)},noPagination:function(){return React.createElement("li",{className:"no_more"},"No other pages")},render:function(){var e="paginator on";if(this.props.nPages>1)var a=this.updateArr(),i=a.map(this.paginationItems);else if(this.props.nPages=0)var i=this.noPagination();else{var i=[];e="paginator"}return React.createElement("ul",{className:e},i)}}),module.exports=Pagination;
...
var React=require("react/addons"),ReactCSSTransitionGroup=React.addons.CSSTransitionGroup,axios=require("axios"),timelineJsonData=require("./data/timeline.json"),HoH=require("./js/dispatcher.js");window.app=function(){for(var e={"JSON decoding":window.JSON,"the selectors API":document.querySelector,"DOM level 2 events":window.addEventListener,"the HTML5 history API":window.history.pushState},t=e.length-1;t>=0;t--)if(!e[t])return alert("Sorry, but your browser does not support "+feature+" so this app won't work properly.");if("/history-of-humanity/"===window.location.pathname)return React.render(React.createElement(HoH,{timeline:timelineJsonData,initparams:{year:!1,position:!1,name:!1}}),document.getElementById("hoh"));var i=window.location.pathname.replace("/history-of-humanity/","").split("/"),a={year:i[0],position:i[1],name:i[2]},o={itemDetail:timelineJsonData[a.year][a.position],wikiData:!1,wikiImages:[]},n="https://en.wikipedia.org/w/api.php?format=json&action=query&prop=extracts|images&exintro=&explaintext=&titles="+a.name;axios.get("https://apis.builtvisible.com/history_of_humanity/?url="+encodeURIComponent(n.replace(/&amp;/g,"&"))).then(function(e){if(isset(e.data.query.pages)){var t=Object.keys(e.data.query.pages);return o.wikiData=e.data.query.pages[t],React.render(React.createElement(HoH,{timeline:timelineJsonData,initparams:a,initwikidata:o}),document.getElementById("hoh"))}})["catch"](function(e){console.log("error in xhr"),console.log(e)})}();
