...
var React=require("react/addons"),ReactCSSTransitionGroup=React.addons.CSSTransitionGroup,axios=require("axios"),timelineJsonData=require("./data/timeline.json"),HoH=require("./js/dispatcher.js");window.app=function(){for(var e={"JSON decoding":window.JSON,"the selectors API":document.querySelector,"DOM level 2 events":window.addEventListener,"the HTML5 history API":window.history.pushState},t=e.length-1;t>=0;t--)if(!e[t])return alert("Sorry, but your browser does not support "+feature+" so this app won't work properly.");if(null!==String(window.location.pathname).match(/\/history-of-humanity\/\d+\/\d+\/.+/i)){var i=window.location.pathname.replace("/history-of-humanity/","").split("/"),a={pointer:0,year:i[0],position:i[1],name:i[2]},n={itemDetail:timelineJsonData[a.year][a.position],wikiData:!1,wikiImages:[]},o="https://en.wikipedia.org/w/api.php?format=json&action=query&prop=extracts|images&exintro=&explaintext=&titles="+a.name;axios.get("https://apis.builtvisible.com/history_of_humanity/?url="+encodeURIComponent(o.replace(/&amp;/g,"&"))).then(function(e){if(isset(e.data.query.pages)){var t=Object.keys(e.data.query.pages);return n.wikiData=e.data.query.pages[t],React.render(React.createElement(HoH,{timeline:timelineJsonData,initparams:a,initwikidata:n}),document.getElementById("hoh"))}})["catch"](function(e){console.log("error in xhr"),console.log(e)})}else{if(null===String(window.location.pathname).match(/\/history-of-humanity\/p\/\d+/i))return React.render(React.createElement(HoH,{timeline:timelineJsonData,initparams:{pointer:0,year:!1,position:!1,name:!1}}),document.getElementById("hoh"));var i=window.location.pathname.replace("/history-of-humanity/","").split("/");if(parseInt(i[1])>0)return React.render(React.createElement(HoH,{timeline:timelineJsonData,initparams:{pointer:parseInt(i[1])-1,year:!1,position:!1,name:!1}}),document.getElementById("hoh"));window.location.replace("https://labs.builtvisible.com/history-of-humanity/")}}();
