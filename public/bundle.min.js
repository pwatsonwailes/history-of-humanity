...
var React=require("react/addons");Pagination=React.createClass({displayName:"Pagination",clickHandler:function(e){e.preventDefault(),this.props.clickHandler(parseInt(e.target.dataset.pointer))},updateArr:function(){var e=[];if(this.props.maxBlocks-this.props.nPages<2){maxPivotPages=Math.round((this.props.maxBlocks-5)/2),minPage=Math.max(0,this.props.pointer-maxPivotPages),maxPage=Math.min(this.props.nPages-1,this.props.pointer+2*maxPivotPages-(this.props.pointer-minPage)),minPage=Math.max(0,minPage-(2*maxPivotPages-(maxPage-minPage)));var a=!0}else{minPage=0,maxPage=this.props.nPages-1;var a=!1}a&&0!==minPage&&(e[0]="prev",e[1]="hellip1");for(var t=minPage;t<=maxPage;t++)e.push(t);return a&&this.props.nPages!==maxPage+1&&(e.push("hellip2"),e.push("next")),e},renderPaginationItems:function(e){var a=this.props.pointer===e?"selected clickable":"clickable";if("prev"===e)return React.createElement("li",{key:e,className:a},React.createElement("a",{href:"/history-of-humanity/","data-pointer":0,onClick:this.clickHandler},"1"));if("next"===e)return React.createElement("li",{key:e,className:a},React.createElement("a",{href:"/history-of-humanity/p/"+this.props.nPages,"data-pointer":this.props.nPages-1,onClick:this.clickHandler},this.props.nPages));if("hellip1"===e||"hellip2"===e)return React.createElement("li",{key:e,className:"more"},"...");var t=e+1;return React.createElement("li",{key:e,className:a},React.createElement("a",{href:"/history-of-humanity/p/"+t,"data-pointer":e,onClick:this.clickHandler},t))},renderNoPagination:function(){return React.createElement("li",{className:"no_more"},"No other pages")},render:function(){var e="paginator on";if(this.props.nPages>1)var a=this.updateArr(),t=a.map(this.renderPaginationItems);else if(this.props.nPages=0)var t=this.renderNoPagination();else{var t=[];e="paginator"}return React.createElement("ul",{className:e},t)}}),module.exports=Pagination;
