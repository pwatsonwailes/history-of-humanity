...
function isset(t){return"undefined"!=typeof t}var React=require("react/addons"),ReactCSSTransitionGroup=React.addons.CSSTransitionGroup,axios=require("axios"),Social=require("./react-social.js"),Controls=require("./react-controls.js"),GMap=require("./react-gmaps.js"),ItemList=require("./react-itemlist.js"),ItemDetail=require("./react-itemdetail.js");React.initializeTouchEvents(!0);var HoH=React.createClass({displayName:"HoH",getInitialState:function(t){return{startDate:0,endDate:0,pointer:0,show:25,tag:!1,selectedItems:[],highlightLatLong:!1,itemDetail:!1,wikiData:!1,wikiImages:!1}},componentWillMount:function(){this.updateItems(!1,!1,!1)},componentDidMount:function(){var t=this;isset(this.props.initparams)&&this.props.initparams.year!==!1&&this.setItemDetail({target:{dataset:{year:this.props.initparams.year,position:this.props.initparams.position}}}),History.Adapter.bind(window,"statechange",function(){t.historyUpdate()})},updateItems:function(t,e,a){var i={},s=[],r=0;if(t===!1){var n=1750,o=2015;i.startDate=n,i.endDate=o}else var n="startDate"===t?parseInt(e):parseInt(this.state.startDate),o="endDate"===t?parseInt(e):parseInt(this.state.endDate);for(var p=n;o>=p;p++)for(var h=isset(this.props.timeline[p])?this.props.timeline[p].length:0,l=0;h>l;l++)(a!==!1&&this.props.timeline[p][l].tags.indexOf(a)>-1||a===!1)&&(s[r]=this.props.timeline[p][l],s[r].year=p,s[r].position=l,r++);this.state.pointer>=Math.floor(s.length/this.state.show)&&(i.pointer=Math.floor(s.length/this.state.show)),i.tag=a,i.selectedItems=s,update=!0,t!==!1&&(i[t]=e),this.setState(i)},historyUpdate:function(){var t=window.location.pathname.replace("/history-of-humanity/","").split("/");isset(t[1])&&""!==t[1]&&t[1]!==!1?this.setItemDetail({target:{dataset:{year:t[0],position:t[1]}}},!1):this.hideItemDetail({target:{id:"hohContainer"}},!1)},setItemDetail:function(t,e){if("function"==typeof t.preventDefault&&t.preventDefault(),isset(t.target.dataset.year))var a=t.target.dataset.year;else if(isset(t.target.parentNode.dataset.year))var a=t.target.parentNode.dataset.year;else if(isset(t.target.parentNode.parentNode.dataset.year))var a=t.target.parentNode.parentNode.dataset.year;if(isset(t.target.dataset.position))var i=t.target.dataset.position;else if(isset(t.target.parentNode.dataset.position))var i=t.target.parentNode.dataset.position;else if(isset(t.target.parentNode.parentNode.dataset.position))var i=t.target.parentNode.parentNode.dataset.position;var s=this.props.timeline[a][i];if(isset(s.links.main)){var r=s.links.main.link.replace("//en.wikipedia.org/wiki/","");this.setWikiData(r)}else this.setState({wikiData:!1,wikiImages:!1});this.setState({itemDetail:s}),isset(e)&&e===!1||History.pushState(null,s.text+" | History of Modern Humanity | Builtvisible","/history-of-humanity/"+a+"/"+i+"/"+r)},hideItemDetail:function(t,e){("hohContainer"===t.target.id||"hideItemDetail"===t.target.id||"hideItemDetail"===t.target.parentNode.id)&&(this.setState({itemDetail:!1}),isset(e)&&e===!1||History.pushState(null,"History of Modern Humanity | Builtvisible","/history-of-humanity/"))},setWikiData:function(t){var e=this,a="https://en.wikipedia.org/w/api.php?format=json&action=query&prop=extracts|images&exintro=&explaintext=&titles="+t,i=axios.get("https://apis.builtvisible.com/history_of_humanity/?url="+encodeURIComponent(a.replace(/&amp;/g,"&")));i.then(function(t){var a={wikiData:!1,wikiImages:!1};if(isset(t.data.query.pages)){var i=Object.keys(t.data.query.pages);if(a.wikiData=t.data.query.pages[i],a.wikiImages=[],isset(a.wikiData.images))for(var s=a.wikiData.images.length-1;s>=0;s--){var r=a.wikiData.images[s].title.replace("File:","").replace(/\s+/g,"_");if(-1===r.indexOf(".jpg")&&-1===r.indexOf(".png")&&0===s)a.wikiData.images.splice(s,1);else if(-1===r.indexOf(".jpg")&&-1===r.indexOf(".png")){a.wikiData.images.splice(s,1);continue}var n="https://en.wikipedia.org/w/api.php?action=query&titles=Image:"+r+"&prop=imageinfo&iiprop=url&format=json",o=axios.get("https://apis.builtvisible.com/history_of_humanity/?url="+encodeURIComponent(n.replace(/&amp;/g,"&")));0===s?o.then(function(t){isset(t.data.query.pages[-1])&&isset(t.data.query.pages[-1].imageinfo)&&a.wikiImages.push(t.data.query.pages[-1].imageinfo[0].url),e.setState(a)})["catch"](function(t){console.log("error in xhr 2"),console.log(t)}):o.then(function(t){isset(t.data.query.pages[-1])&&isset(t.data.query.pages[-1].imageinfo)&&a.wikiImages.push(t.data.query.pages[-1].imageinfo[0].url)})["catch"](function(t){console.log("error in xhr 3"),console.log(t)})}else e.setState(a)}})["catch"](function(t){console.log("error in xhr 1"),console.log(t)})},updateDate:function(t){if(!isNaN(t.x)){var e=Math.floor(t.x);"startDate"===t.name&&e!==this.state.startDate?this.updateItems("startDate",e,this.state.tag):"endDate"===t.name&&e!==this.state.endDate&&this.updateItems("endDate",e,this.state.tag)}},updatePointer:function(t){var e=!0;if(isset(t.target.parentNode.dataset.pointer))var a=t.target.parentNode.dataset.pointer;else if(isset(t.target.dataset.pointer))var a=t.target.dataset.pointer;if("1"===a&&this.state.pointer+1<Math.floor(this.state.selectedItems.length/this.state.show))var i=this.state.pointer+1;else if("1"===a&&this.state.pointer+1>=Math.floor(this.state.selectedItems.length/this.state.show))e=!1;else if("0"===a&&this.state.pointer>0)var i=this.state.pointer-1;else var i=0;e&&this.setState({pointer:i})},handleMarkerClick:function(t){this.setState({highlightLatLong:t})},updateTag:function(t){t.preventDefault();var e=t.target.dataset.value;""===e&&(e=!1),this.updateItems("endDate",this.state.endDate,e),window.tagToggler._closeMenu()},renderItemDetail:function(){return React.createElement("div",{key:"itemDetailContainer"},React.createElement(ReactCSSTransitionGroup,{id:"hideItemDetail",transitionName:"itemDetailTransition",transitionAppear:!0,onClick:this.hideItemDetail},React.createElement("i",{className:"fa fa-times"})),React.createElement(ItemDetail,{itemDetail:isset(this.props.initwikidata)?this.props.initwikidata.itemDetail:this.state.itemDetail,wikiData:isset(this.props.initwikidata)?this.props.initwikidata.wikiData:this.state.wikiData,wikiImages:isset(this.props.initwikidata)?this.props.initwikidata.wikiImages:this.state.wikiImages}))},render:function(){var t=(this.state.startDate.toString()+this.state.endDate.toString(),this.state.startDate.toString()+this.state.endDate.toString()+this.state.tag+this.state.pointer),e=this.state.itemDetail!==!1||isset(this.props.initwikidata)?this.renderItemDetail():[];return React.createElement("div",{id:"hohContainer",onClick:this.hideItemDetail},React.createElement(Social,null),React.createElement("div",{id:"mapAndControls"},React.createElement(GMap,{initialZoom:3,centerLat:30,centerLng:30,mapsKey:t,items:this.state.selectedItems,pointer:this.state.pointer,handleMarkerClick:this.handleMarkerClick,show:this.state.show}),React.createElement(Controls,{startDate:this.state.startDate,endDate:this.state.endDate,tag:this.state.tag,inputHandler:this.updateDate,tagHandler:this.updateTag,buttonHandler:this.updatePointer})),React.createElement(ItemList,{items:this.state.selectedItems,highlightLatLong:this.state.highlightLatLong,pointer:this.state.pointer,show:this.state.show,itemHandler:this.setItemDetail}),e)}});module.exports=HoH;
